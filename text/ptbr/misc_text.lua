...
town_prefs="Aaron;Abbott;Abel;Abner;Adair;Ahern;Alan;Albert;Alger;Allen;Als;Alva;Alvin;Amos;Andre;Andrew;Andy;Angelo;Ansel;Antoine;Antony;Archer;Aries;Arlen;Armand;Arno;Arnold;Arthur;Arvin;Asa;Aubrey;Augus;Avery;Baird;Bal;Baldwin;Bard;Barlow;Barnett;Baron;Barret;Barry;Bart;Bartley;Basil;Beacher;Beck;Bene;Bennett;Benson;Berk;Bernard;Bernie;Bert;Berton;Bevis;Bill;Blair;Blake;Blithe;Booth;Boris;Bowen;Boyce;Boyd;Brady;Brandon;Brian;Brook;Bruce;Bruno;Buck;Burke;Burnell;Byron;Calvin;Cam;Carey;Carl;Carr;Carter;Cash;Cecil;Chad;Chapman;Charles;Chasel;Chester;Clare;Clark;Claude;Cliff;Clyde;Colbert;Colby;Colin;Conrad;Corey;Corn;Cornell;Cyril;Dana;Daniel;Darcy;Darnell;Darren;Dave;Dean;Del;Dempsey;Dennis;Derrick;Devin;Donahue;Donald;Dunn;Dwight;Dylan;Earl;Earl;Ed;Eden;Edgar;Edmund;Edwiin;El;Eli;Elijah;Ellis;Elmer;Elroy;Elvis;Enoch;Eric;Eugene;Evan;Everley;Fabian;Fitch;Fox;Fren;Gale;Gary;Gavin;Gel;Gene;Geoff;George;Gerald;Gilbert;Giles;Glenn;Goddard;Gordon;Greg;Griff;Grover;Hale;Hardy;Harlan;Harley;Harold;Harriet;Harry;Harvey;Hel;Herbert;Hex;Hilary;Hiram;Hobart;Hogan;Hol;Horace;Howar;Hox;Hubery;Hunter;Hyman;Ian;Il;Ingemar;Ira;Isaac;Isidore;Ivan;Ives;Jacob;Jared;Jason;Jeff;Jeffrey;Jeremy;Jerome;Jonas;Joshua;Joyce;Justin;Keith;Kelly;Ken;Kennedy;Kent;Kerr;Kerwin;Kevin;Kim;Kirk;Kyle;Lambert;Lance;Larry;Leif;Len;Lennon;Leonard;Les;Lester;Levi;Lewis;Lucien;Luther;Lyle;Lynn;Malcolm;Mandel;Marcus;Marlon;Marsh;Maurice;Merle;Merlin;Miles;Moore;Morgan;Murphy;Murray;Myron;Nam;Nat;Nathan;Neil;Nes;Nigel;Noah;Noel;Ogden;Ol;Old;Olf;Oliver;Omar;Osborn;Oscar;Osmond;Otis;Otto;Oul;Owen;Ox;Paddy;Parker;Payne;Perry;Phil;Ply;Porter;Primo;Quennel;Quentin;Quincy;Rachel;Ralap;Raymond;Reg;Regan;Reuben;Rex;Robin;Rock;Rod;Rodney;Ron;Rook;Rory;Roy;Rudolf;Rupert;Ryan;Sal;Sam;Sam;Samuel;Sandy;Scott;Sean;Sed;Sel;Sid;Sidney;Sil;Simon;Stan;Sunder;Tab;Tal;Taylor;Ted;Tiffany;Tim;Timothy;Tobias;Toby;Todd;Tony;Tracy;Tyler;Tyrone;Uriah;Vic;Virgil;Vito;Vivian;Wade;Walker;Walter;Wayne;Webb;Wendell;Werner;Wet;Wilbur;Will;Willie;Wright;Wythe;York;Yves;Zachary"
town_suffs="burgh;bury;dale;ham;land;poli;polis;shire;ton;ville;wich;wick"

-- Dungeon name adjectives/nouns, e.g. Forgotten %s + Ruins -> Forgotten Ruins.
dgn_adjs=[[
Caído %s;Esquecido %s;%s do Esquecido;Perdido %s;%s da Honra Perdida;Oblivion %s;
Dormindo %s;Sempre Dormindo %s;Sem Sono %s;do Dorminhoco %s;dos Dorminhocos %s;%s do Dorminhoco;%s dos Dorminhocos;Pesadelo %s;
...
Sem Fundo %s;Interminável %s;Sem Rosto %s;Sem Nome %s;Arcano %s;Oculto %s;Secreto %s;Proibido %s;Selado %s;%s do Selo;%s da Esperança;Destino %s;%s do Destino;Fortuna %s;Felicidade %s;Alegre %s;Solitário %s;Agonia %s;Praga %s;Grande %s;Tempo %s;%s do Tempo;Cinza %s;Cinza Negra %s;Pena Negra %s;
Fogo Prateado %s;Asa Prateada %s;Areias Quentes %s;Areias Cantantes %s;%s das Tempestades;O Envolto %s;
Esmeralda %s;Cristal %s;Fluorita %s;Rubi %s;Obsidiana %s;
Madeira Morta %s;Carvalho Sábio %s;O Codex %s;Raiz de Sangue %s;Capa Cinza %s;
Preto %s;Branco %s;Cinza %s;Vermelho %s;Verde %s;Azul %s;Dourado %s;Roxo %s;
Urso Preto %s;Urso Branco %s;Urso Cinza %s;Raposa Preta %s;Raposa Branca %s;Raposa Cinza %s;Raposa Cinza %s;Raposa Prateada %s;Víbora %s;Serpente %s;Cobra %s;Corvos %s;Corvo Sepulcral %s;Falcão Noturno %s;Wyrms %s;Wyrms' %s;Behemoth %s;Hydra %s;
...
Anão %s;Anões das Colinas' %s;Anões das Montanhas' %s;Anões Profundos' %s;Duergar' %s;Anões Dourados' %s;Anões de Escudo' %s;
...
Arqueiro Arcano' %s;Trapaceiro Arcano' %s;Arquimago' %s;Assassino' %s;Guardião Negro' %s;Discípulo do Dragão' %s;Duelista' %s;Defensor Anão' %s;Cavaleiro Eldritch' %s;Hierofante' %s;Caminhante do Horizonte' %s;Mestre das Lendas' %s;Teurgo Místico' %s;Dançarino das Sombras' %s;Taumaturgo' %s;Mestre da Lâmina' %s;Senhor Elemental' %s;
...
ruins_nouns		="Ruínas;Restos;Queda;Escavação"
temple_nouns	="Templo;Santuário;Santuário;Abrigo;Santuário;Altar;Labirinto;Labirinto;Gaiola;Prisão"
tomb_nouns		="Tumba;Tumbas;Sepultura;Mausoléu;Cemitério;Cemitério;Cemitério de Ossos;Cemitério;Cemitérios;Cripta"
tower_nouns		="Torre;Farol;Pináculo"


s_lv_x_spls		="Magias de Nível-X"
local d_act_grp_spl_x	="O nível de uma magia é um número entre 1 e 9 que define o poder relativo da magia.\n\nUm conjurador deve possuir nível de classe de conjurador suficientemente alto e valor de habilidade de conjuração para lançar magias de determinado nível."
...
[act_grp_cm		]={n="Manobras de Combate"			,d="Depois de aprender talentos de Manobras de Combate, você pode tentar executar várias manobras que podem atrapalhar ou até incapacitar seu inimigo, incluindo Derrubar, Agarrar, Investida, Arrastar e Avançar."},
...
[act_grp_special]={n="Ações Especiais"			,d="Algumas classes concedem ao personagem ações especiais adicionais."},
...
s_del				="Excluir"
del					="Excluir"-- del
pls_sel				="Por favor, selecione"
sel_img_dlg_title	="Selecionar Imagem"
def_input_dlg_title	="Inserir Novo Texto"
sel_dir				="Selecionar Pasta"
...
enc_info			="Informações do Desafio"
s_defeated			="DEFEATED"
s_btl_win			="VICTORY"
s_btl_lost			="DEFEATED"
...
s_total_wins		="Vitórias"
s_total_losts		="Derrotas"
s_total_kills		="Abates"
s_total_pc_deads	="Mortes"
...
btn_upd_encs		="<h3 c=lbl>Desafiar CHEFE!</h3>Enfrente um desafio de CHEFE depois que todos os desafios atuais forem derrotados."
s_arn_rst			="Recarregar Desafios"	s_arn_rst_d	="Recarrega um lote de desafios de dificuldade designada por uma taxa."
s_clr_all_win		="Marcar todos os desafios como não derrotados"
s_set_all_win		="Marcar todos os desafios como derrotados"
s_set_most_win		="Marcar todos os desafios como derrotados (exceto o último)"
...
s_rst_arn_upds		="Redefinir Vantagens de Campeão"	s_rst_arn_upds_d	="Cancele todas as vantagens de campeão selecionadas e receba de volta 80% of pontos de glória."
s_req_arn_sub		="Requer a vantagem de campeão correspondente."
s_arn_cfg			="Opções de Vantagens de Campeão"	s_arn_cfg_d	="Opções de vantagens exclusivas do campeonato dão a você mais controle sobre a batalha na ponta dos dedos!"
...
cfg_minion			={n="Configurações de Minions", d="Ajuste a quantidade máxima de monstros minions dos desafios."}
minion_max			="Quantidade máxima de monstros minions"
...
s_arn_upd_cft		="Artesanato"				s_arn_upd_cft_b		="Custo de artesanato %d%% menor"										s_arn_upd_cft_d		="Custo de artesanato mais baixo e mais opções."
...
s_arn_sub_restock5	="+1 Suprimento Extra"

-- cfg
s_cfg				="Opções"
s_cfg_d				="Altera gráficos, áudio, detalhes do campo de batalha e outras configurações."
...
wnd_wxh				="Resolução em modo janela"
cust				="Personalizado..."
cust_wxh			="Personalizar resolução"
err_wxh				="Resolução inválida!"
...
shuffle_music		="Reproduzir música em modo aleatório<c=twa> (por padrão, na ordem das faixas)</c>"
boss_music			="Música especial para batalhas de CHEFE"
btl_music			="Música especial para batalhas normais"
s_tip_rb			="Mostrar dicas no canto inferior direito da tela"
show_u_bf_ex		="Mostrar condições nas dicas"
show_simple_act_tip	="Mostrar dicas das ações Mover e Defender"
s_low_fps			="Ativar este recurso pode reduzir significativamente o FPS nos turnos de personagens à distância."
...
vp_out_only			="Só quando o personagem sair da visualização"
...
mov_ani				="Velocidade das animações de movimento e visualização"
...
disp_dice			="Mostrar dados de dano na descrição da arma/ação, ex. 2d6<c=twa> (desmarcado: intervalo de dano, 2-12)</c>"
disp_sum_dice		="Mostrar dados de dano na dica de ataque/painel do personagem"
show_dnd_ch			="Mostrar intervalo de ameaça da arma, ex. 19-20/x2<c=twa> (10%/x2 por padrão)</c>"
...
pre_buy				={n="Trancar/Destrancar"	,d="Trancar o item selecionado a 5% do preço para compra futura.\n\n<c=fc_o>• Itens destrancados desaparecerão!\n• A taxa de trancamento não é reembolsável."}
...
pty_bag				="Mochila do Grupo"
pty_box				="Armazenamento do Grupo"
...
withdraw_gp			={n="Sacar", d="Sacar uma quantidade especificada de moedas de ouro do seu saldo bancário."}
...
dismiss				="Demitir"
s_employ			="Empregar"
s_unemploy			="Dispensar"
bury				="Enterrar"
pc_list				="Lista de Personagens"
new_pc				="Novo Personagem"
mod_pc				="Modificar Personagem Selecionado"
del_pc				="Excluir Personagem Marcado"
...
s_rst_pre_pcs_cfm	="Reinicia todos os personagens pré-criados. Tem certeza?\n<c=twa>(Não afeta os personagens personalizados do jogador)</c>"

chg_name_look		="Alterar Nome & Imagens"
chg_portait			="Alterar Retrato"
chg_avatar			="Alterar avatar e retrato associado"
s_rd_sprt			="Avatar aleatório por raça e classe"
s_sync_face			="Definir retrato associado ao avatar"
chg_u_bld			="Alterar Build"

mk_pty_from_cur		="Clonar Grupo Atual"
mk_pty_from_tpl		="Modelos de Grupo"
submit_arena_pty	="Enviar Grupo Atual"

cpy_pty_txt			="Copiar Detalhes do Grupo para a Área de Transferência (TXT)"
cpy_pty_ubb			="Copiar Detalhes do Grupo para a Área de Transferência (UBB)"
cpy_u_txt			="Copiar Detalhes do Personagem para a Área de Transferência (TXT)"
cpy_u_ubb			="Copiar Detalhes do Personagem para a Área de Transferência (UBB)"


-- new pc/lv up
s_unnamed			="Sem Nome"
pc_name				="Nome do Personagem"
rd_name				="Nome Aleatório"
portait				="Retrato"
btl_ico				="Avatar"
...
s_relv_d			="Por uma taxa, restaure o nível de um personagem ao seu estado original e escolha uma classe, talentos, magias, etc. a partir do nível 1.\n\nOs pontos de experiência e pontos de proficiência em perícias existentes do personagem serão mantidos.\n\nNota: As barras de ação de combate do personagem serão redefinidas ao estado padrão."
s_relv_cfm			="Re-treinar o(s) personagem(s)?\n\n<c=ty>Custo: </c>%s"
s_lvup				="Subir de Nível"	s_lvup_d	="Subir de nível melhora seus personagens de várias formas: mais pontos de vida, bônus de ataque básico e testes de resistência mais altos, atributos adicionais, novos talentos e até novas magias, etc."
--finish			="Finish"
--next_step			="Next"
creation_mode		="Modo de Criação"
sel_race			="Raça"
sel_race_bns		="Atributos Bônus"
sel_cls				="Classe"
...
merge_same_itms		="Mesclar Itens Idênticos"
auto_sort			="Ordenação Automática"
auto_sort_cfg		="Opções de Ordenação Automática"
...
- Clique direito no item: equipar/desequipar rápido
- Shift ou Ctrl + clique: dividir itens
- Arma arremessável -> slot de munição
- Munições diferentes nos slots de munição para recarga parcial automática]]}


-- sys
s_mov_up			="Mover para Cima"
s_mov_down			="Mover para Baixo"
s_mov_top			="Mover para o Topo"
s_mov_btm			="Mover para o Fundo"
page_up				="Página Anterior"
page_down			="Próxima Página"
...
quick_load_cfm		="Carregar o último progresso salvo do jogo?\n(O progresso atual do jogo será perdido)"
save_quit			="Salvar e Sair"
s_saving			="Salvando..."
game_saved			="Jogo salvo."
save_lost_cfm		="O progresso atual não salvo será perdido. Continuar?"
save_quit_cfm		="Salvar o progresso atual do jogo e sair para a área de trabalho?"
can_load_save		="Não foi possível carregar o salvamento!"
can_load_arn_save	="Não foi possível carregar o salvamento! Criando e usando o grupo padrão."


-- workshop
ugc_submit_pc				= {n="Enviar"	,d="<h3 c=lbl>Enviar Conteúdo para o Steam Workshop</h3>Enviar personagens verificados para o Steam Workshop."}
...
smod_menu_arena_map			= "Enviar Mapas de Batalha da Arena"
smod_menu_adv_pty			= "Enviar Grupo de Aventura"
smod_menu_adv_module		= "Enviar Módulo de Aventura"
smod_menu_gameplay			= "Enviar MOD de Jogabilidade"
smod_menu_lang				= "Enviar MOD de Idioma"
smod_menu_all				= "Enviar MOD Abrangente"
...
smod_def_title_arena_pty	= "Minha Party da Arena"
...
smod_def_title_all			= "Meu MOD Abrangente"

smod_dir_lbl_pc				= "Pasta de Conteúdo:"
smod_dir_lbl_gfx_pc_face	= "Pasta de Imagens de Conteúdo (JPG ou PNG, tamanho ideal 72x72):"
smod_dir_lbl_gfx_pc_img		= "Pasta de Imagens de Conteúdo (PNG, tamanho ideal 96x96):"
smod_dir_lbl_gfx_mo_img		= "Pasta de Imagens de Conteúdo (PNG, tamanho ideal 96x96):"
smod_dir_lbl_gfx_all		= "Pasta de Conteúdo (similar à pasta <url=./gfx>gfx</url> no diretório do jogo):"
smod_dir_lbl_arena_pty		= "Pasta de Conteúdo:"
smod_dir_lbl_arena_enc		= "Pasta de Conteúdo:"
smod_dir_lbl_arena_map		= "Pasta de Conteúdo:"
smod_dir_lbl_adv_pty		= "Pasta de Conteúdo:"
smod_dir_lbl_adv_module		= "Pasta de Conteúdo:"
smod_dir_lbl_gameplay		= "Pasta de Conteúdo:"
smod_dir_lbl_lang			= "Pasta de Conteúdo:"
smod_dir_lbl_all			= "Pasta de Conteúdo:"

smod_menu_lma_ugc			= "Navegar no Workshop Low Magic Age"

smod_new					= "Novo Item do Workshop"
smod_dlg_title				= "Enviar Conteúdo para o Steam Workshop"
smod_new_or_upd_lbl			= "Criar Novo ou Atualizar Item do Workshop:"
...
ugc_preview_sz_err			= "O tamanho do arquivo da imagem de pré-visualização deve ser menor que 1 MB!"
...
-- game terms
gold_piece		= {n="Peças de Ouro"	,d="A moeda mais comum que os aventureiros usam é a peça de ouro."}
item			= {n="Item", p="Itens"}
...
s_bk_pcs		= "Personagens Substitutos"	s_bk_pcs_d	="Membros do grupo que não são necessários temporariamente podem ser colocados aqui."
s_bk_npcs		= "Empregados Substitutos"	s_bk_npcs_d	="Empregados que não são necessários temporariamente podem ser colocados aqui."
s_bk_pcs_max	= "Número máximo de slots substitutos"
s_bk_pcs_lmt	= "Os slots substitutos atingiram o limite!"
...
s_bg_sprt		= "Avatar"
s_bg_alpha		= "Definir Transparência de Fundo"
...
fee				= "Taxa"
s_act_pwr		= "Uso ativo"
s_swt_pwr		= "Tipo liga-desliga"
auto_gained		= "Ganho automático"

s_provoke_ao	= "Provocar ataques de oportunidade"
s_provoke_ao2	= "Provocar AO e teste de concentração"
atk_pnl2		= "Penalidade de ataque -2"
--atk_pnl4		= "Attack Penalty -4"
has_full_bns	= "Bônus de ataque total"
--not_spl		= "Non-spell"
--cd_turns		= "Turns CD" -- e.g. 3 Turns CD
true_hit		= "Acerto verdadeiro"
s_tgt			= "Alvo"
rng				= "Alcance"
aoe				= "Área"
s_dur			= "Duração"
...
s_dur_2h		= "2 horas"
s_dur_d			= "1 dia"
s_dur_perm		= "Permanente"
s_dur_cl		= "1 rodada/nível"
s_dur_cl_m		= "10 rodadas/nível"-- 1 min./level
s_dur_cl_ma		= "10 min./nível"
s_dur_cl_h		= "1 hora/nível"
...
s_dur_rage		= "3 + modificador de Con (recém-melhorado)"
s_dur_area		= "Na área"
...
tmp_hp			= "HP Temporário"
cur_hp			= "HP Atual"
max_hp			= "HP Máximo"
s_tgt_chp		= "HP Atual do Alvo"
s_tgt_mhp		= "HP Máximo do Alvo"
s_heal_hp		= "Curar HP"
s_heal_pts_left	= "Pontos de cura restantes"

spd				= {n="Velocidade", a="SPD", d="Sua velocidade indica o quão longe você pode se mover em uma rodada. Ela depende principalmente da sua raça e da armadura que está usando."}
init			= {n="Iniciativa", a="INIT", d="No início de uma batalha, cada combatente faz um teste de iniciativa: iniciativa base + d20. Iniciativa base = modificador de Destreza + outros modificadores.\n\nApós os testes de iniciativa, os personagens agem em ordem, contando de forma decrescente do maior resultado ao menor. Em cada rodada subsequente, os personagens agem na mesma ordem (a menos que um personagem tome uma ação que faça sua iniciativa mudar)."}
can_ao			= "Pode fazer ataques de oportunidade"


-- btl
set_tile_sz		="Definir Tamanho do Azulejo"
show_grid		="Grade"
...
flee_msg_chase	="Perseguindo Estatísticas de Casualidades"
s_casualty_rate	="Taxa de Casualidade"

btl_beg_log			= "---- Batalha Iniciada ----"
round_log			= "---- Turno %s ----"
s_turn_beg			= "Turno Iniciado"
unseen_act_log		= "%s está realizando uma ação fora de vista..."
into_fov_log		= "%s apareceu em vista"
area				= "Área"
area_gone_log		= "A área %s desapareceu."
...
failed				= "Falha"
s_chk_f				= "Teste %s: %s %s."
s_u_chk_f			= "%s faz um teste <c=ty>%s</c>: %s %s."
s_u_aid_chk_f		= "%s faz um teste de <c=ty>Ajuda</c>: %s %s."
...
use					= "usa"
use_lbl				= "Usar"
tgr_ko				= "Acionar teste de queda"
no_tgr_ko			= "Nenhum teste de queda acionado"
...
summon			= "Invocar"
tip_to_ud		= "Transformar em morto-vivo"
banished		= "banido"
ignite			= "Incendiar"
ignited			= "incendiado"
clear			= "Limpar"
...
s_ends			= "termina"
s_dismiss		= "Dispensar"
s_dismisses		= "dispensa"

u_sz			= "Tamanho"
pnl_v			= "Penalidade"
--prof			= "Proficiency"
not_prof		= {n="Não proficiente",d="-4 de penalidade nas rolagens de ataque ao usar armas não proficientes. Usar armaduras ou escudos não proficientes impõe penalidade nas rolagens de ataque e no Reflexo."}
...
nac				= "Armadura Natural"
burden			= "Carga"
racial_trait	= "Traço Racial"
slow_n_steady	= "Lento e Constante"
half_spd		= "Meia Velocidade"
slow			= "Lento"
...
s_set_act_tip		= "<ico=kb/m_l>Clique com o botão esquerdo para arrastar e soltar ações existentes\n<ico=kb/m_r>Clique com o botão direito para definir novas ações"
s_act_bar_pg_tip	= "<h3 c=lbl>Página Atual da Barra de Ações</h3>Navegue entre as páginas usando os botões laterais ou teclas de atalho.\n\nBarra de Ações:\n"..s_set_act_tip
set_act				= "Definir Ação"
s_del_act			= "Excluir Ação Selecionada"
s_del_act_r			= "Excluir Ações Selecionadas e à Direita"
s_del_act_all		= "Excluir Todas as Ações"
s_del_act_r_cfm		= "Excluir a ação selecionada e as ações à direita?\n(Não afetará as ações de outras páginas)"
...
[[A rolagem de dado D20 (dado de vinte faces) é amplamente usada na maioria dos testes que envolvem taxas de acerto ou sucesso, como ataques ou desarmar armadilhas.


Existem 4 implementações alternativas de rolagem de dado D20:

<c=ty b>1. Embaralhar Lista:</c>
- Gere uma lista de números de 1~20.
- Embaralhe a lista.
- Escolha o primeiro número da lista como resultado.

<c=ty b>2. Embaralhar Aleatório:</c>
- Gere uma lista de números de 1~20.
- Embaralhe a lista.
...
- Aplique o módulo ao número: número % 20 + 1 = 1~20.
- O número final é o resultado.


Todos os algoritmos acima podem realizar o trabalho adequadamente. Contudo, para um espaço de amostra pequeno, os algoritmos 1 e 2 apresentam distribuição mais uniforme na maioria dos sistemas computacionais.]]}

rd20s={-- z_rd20
{n="Embaralhar Lista"	},
{n="Embaralhar Aleatório"	},
{n="Lista Aleatória"	},
{n="RNG Padrão"	},
}
...
{n="Que afeta a mente"			,d="Imune a efeitos que afetam a mente (sono, medo, encanto, etc.)"},
...
{n="Dano de Habilidade Física",d="Imune a dano de habilidade física (Str, Dex, Con)"},
...
{n="Treinamento de Escudos e Armaduras"	},
...
{n="Ataque Corpo a Corpo por Toque"		},
{n="Ataque à Distância por Toque"	},
{n="Magia"					},
{n="Ataque de Manobra de Combate"	,a="CMA"},
{n="Teste de Turno"				},
{n="Teste de Intimidação"		},
{n="Teste de Enganação"			},
{n="Teste de Cura"				},
{n="Ataque Especial"			},
}
...
{n="Padrão"	,d=[[Monstros padrão têm força padrão.]]},


{n="Elite"		,d=[[Monstros elite são mais resistentes que monstros padrão do mesmo papel e nível.

Um monstro elite conta como dois monstros padrão de seu nível, valendo o dobro de XP e sendo duas vezes mais perigoso.

Monstros elite são ótimos "mini-chefes", por exemplo, um grupo de ogros liderado por um ogro elite, ou dois caçadores gnoll elite liderando uma matilha de gnolls.]]},
...
Um monstro solo vale a mesma quantidade de XP que cinco monstros de seu nível. Ele oferece o mesmo nível de desafio que cinco monstros, mas tem a capacidade de ficar de pé e lutar por conta própria.]]},
...
Quatro lacaios são considerados equivalentes a um monstro padrão de seu nível, mas um lacaio é destruído ao receber qualquer quantidade de dano.]]},
...
num_desc_one	= "Um"
num_desc_few	= "Poucos"
num_desc_some	= "Alguns"
num_desc_pack	= "Um bando de"

btl_diffs={-- z_btl_diff
{n="Personalizado"		,d="Dificuldade de combate personalizada."},
{n="Descontraído"	,d="Personagens jogadores recebem apenas 20% d de dano, e cometem significativamente menos falhas consecutivas.\n\nMonstros têm penalidade de -4 nas rolagens de ataque e nas defesas, e não multiplicam dano em acertos críticos."},
{n="Fácil"		,d="Personagens jogadores recebem apenas 40% d de dano, e cometem menos falhas consecutivas.\n\nMonstros têm penalidade de -2 nas rolagens de ataque e nas defesas, e não multiplicam dano em acertos críticos."},
{n="Moderado"	,d="Personagens jogadores recebem apenas 80% d de dano, e cometem menos falhas consecutivas."},
{n="Base"		,d="Não há ajustes em nenhum valor ou mecanismo."},
{n="Difícil"		,d="Personagens jogadores recebem 120% d de dano.\n\nMonstros têm bônus de +2 nas rolagens de ataque e nas defesas."},
{n="Pesadelo"	,d="Personagens jogadores recebem 200% d de dano.\n\nMonstros têm bônus de +4 nas rolagens de ataque e nas defesas, e sempre utilizam as melhores táticas."},
}
...
plyr_miss_bns		={n="Dados de sorte do jogador", d="Quando você faz uma rolagem de ataque e erra, esse valor será adicionado à sua próxima rolagem de ataque. Se errar novamente, o valor dobra, e assim sucessivamente, até que acerte."}
...
s_solo_imm_seckill	="Monstros solo são imunes a efeitos de morte instantânea"
...
enmy_ai				="IA dos monstros"

s_fmt				="Formações"
s_fmt_d				="Escolha uma formação pré-definida ou personalize a formação de batalha."
...
s_prep_spls_b		="A maioria dos conjuradores prepara suas magias com antecedência, seja a partir de um grimório ou por meio de orações devotas e meditação. Selecione as magias que deseja preparar e lance-as após um descanso."
s_prep_spls_d		=s_prep_spls_b.."\n\nSeu nível limita o número de magias que você pode preparar e lançar. Sua alta pontuação de habilidade de conjuração pode permitir que você prepare algumas magias extras.\n\nVocê pode preparar a mesma magia mais de uma vez, mas cada preparação conta como uma magia para o seu limite diário.\n\nPara preparar uma magia, você deve ter uma pontuação de habilidade de conjuração de pelo menos 10 + o nível da magia."
...
s_fami				="Familiar"
s_fami_d			=[[Um familiar é uma criatura mágica que se assemelha a um pequeno animal e é incomumente resistente e inteligente.

Um familiar serve como companheiro e servo. Diferentes familiares concedem habilidades especiais distintas ao seu mestre:
...
- Cobra: O mestre ganha um bônus de +3 em testes de Enganação
- Morcego: O mestre ganha um bônus de +3 em testes de Percepção
- Coruja: O mestre ganha um bônus de +3 em testes de Busca
- Pica-pau: O mestre ganha um bônus de +3 em testes de Lenhador
- Tatu: O mestre ganha um bônus de +3 em testes de Minerador
...
{n="Cobra"		,d="O mestre ganha um bônus de +3 em testes de Enganação"},
{n="Morcego"		,d="Mestre ganha +3 de bônus em testes de ouvir"},
{n="Coruja"		,d="Mestre ganha +3 de bônus em testes de busca"},
{n="Pica-pau"	,d="Mestre ganha +3 de bônus em testes de lenhador"},
{n="Tatu"	,d="Mestre ganha +3 de bônus em testes de mineração"},
}


s_specific_to		="Específico para"

s_uf_live			="Criaturas vivas"-- z_u_flags
s_uf_ud				="Criaturas mortas-vivas"
s_uf_cons			="Criaturas construtos"
...
s_uf_bns_feat		="Um talento extra para criaturas de 1º nível"
s_uf_ally			="Aliados"
s_uf_foe			="Inimigos"
s_uf_non_live		="Criaturas não vivas"
s_uf_non_ud			="Criaturas não mortas-vivas"
s_uf_non_cons		="Criaturas não construtos"
...
s_spe_abi_d			="Uma habilidade especial é extraordinária, semelhante a magia ou sobrenatural por natureza.\n\nUsar uma habilidade especial costuma ser uma ação padrão, mas se é uma ação padrão, uma ação de rodada completa ou nem uma ação, é definido pela própria habilidade."
s_pt2_sp			="Habilidade Semelhante a Magia"
s_pt2_sp_d			="Habilidades semelhantes a magia, como o nome indica, são magias e habilidades mágicas muito parecidas com magias. Habilidades semelhantes a magia estão sujeitas à resistência a magias e ao dissipar magia. Elas não funcionam em áreas onde a magia é suprimida ou anulada.\n\nUsar uma habilidade semelhante a magia funciona como conjurar uma magia, pois requer concentração e provoca ataques de oportunidade. Habilidades semelhantes a magia podem ser interrompidas. Se sua concentração for quebrada, a tentativa de usar a habilidade falha, mas a tentativa conta como se você tivesse usado a habilidade. O tempo de conjuração de uma habilidade semelhante a magia é 1 ação padrão, a menos que a descrição da habilidade indique o contrário."-- ...negated (such as an antimagic field)	Using a Spell-Like Ability on the Defensive: You may attempt to use a spell-like ability on the defensive, just as with casting a spell. If the Concentration check (DC 15 + spell level) fails, you can’t use the ability, but the attempt counts as if you had used the ability.
s_pt2_su			="Habilidade Sobrenatural"
s_pt2_su_d			="Habilidades sobrenaturais são mágicas, mas não são semelhantes a magia. Habilidades sobrenaturais não estão sujeitas à resistência a magias e não funcionam em áreas onde a magia é suprimida ou anulada. O efeito de uma habilidade sobrenatural não pode ser dissipado e não está sujeito a contra-magias.\n\nUsar uma habilidade sobrenatural costuma ser uma ação padrão (a menos que a descrição da habilidade indique o contrário). Seu uso não pode ser interrompido, não requer concentração e não provoca ataques de oportunidade."
s_pt2_ex			="Habilidade Extraordinária"
s_pt2_ex_d			="Habilidades extraordinárias não são mágicas. Contudo, não são algo que qualquer pessoa possa fazer ou até aprender a fazer sem treinamento extensivo. Efeitos ou áreas que anulam ou interrompem magia não afetam habilidades extraordinárias.\n\nUsar uma habilidade extraordinária geralmente não é uma ação porque a maioria delas ocorre automaticamente de forma reativa. As habilidades extraordinárias que são ações costumam ser ações padrão que não podem ser interrompidas, não requerem concentração e não provocam ataques de oportunidade."
...
Cada alinhamento representa uma ampla gama de tipos de personalidade ou filosofias pessoais, portanto dois personagens do mesmo alinhamento ainda podem ser bastante diferentes entre si. Além disso, poucas pessoas são completamente consistentes.]]
s_u_aln_d	= s_u_aln_b.."\n\n\n"..[[
...
Pessoas neutras em relação a bem e mal têm escrúpulos contra matar inocentes, mas carecem do compromisso de fazer sacrifícios para proteger ou ajudar outros. Pessoas neutras são dedicadas a outros por meio de relacionamentos pessoais.
...
Personagens caóticos seguem sua consciência, resentem ser mandados, favorecem novas ideias sobre a tradição e cumprem promessas se assim desejarem.

Alguém neutro em relação à lei e ao caos tem um respeito normal pela autoridade e não sente compulsão nem para obedecer nem para rebelar. Ela é honesta, mas pode ser tentada a mentir ou enganar os outros.


<h2 c=ty>Animais vs. Moral</h2>
Animais e outras criaturas incapazes de ação moral são neutras porque carecem da capacidade moral de serem verdadeiramente boas ou más, legais ou caóticas.


<h2 c=ty>Os Nove Alinhamentos</h2>
Nove alinhamentos distintos definem todas as combinações possíveis do eixo legal-caótico com o eixo bem-mal. Mas lembre-se de que os indivíduos variam dessa norma, e que um personagem pode agir mais ou menos de acordo com seu alinhamento de um dia para o outro.
...
u_alns_text={-- z_ua
[ua_lg]={n="Legal Bom"		,d="Legal Bom, \"Cruzado\": \n\nUm personagem legal bom age como se espera ou se requer de uma pessoa boa. Ele combina o compromisso de combater o mal com a disciplina de lutar incansavelmente. Ele diz a verdade, mantém sua palavra, ajuda os necessitados e se pronuncia contra a injustiça. Um personagem legal bom odeia ver os culpados impunes.\n\nLegal bom é o melhor alinhamento que você pode ter porque combina honra e compaixão."},
[ua_ng]={n="Neutro Bom"		,d="Neutro Bom, \"Benfeitor\": \n\nUm personagem neutro bom faz o melhor que uma pessoa boa pode fazer. Ele é dedicado a ajudar os outros. Ele trabalha com reis e magistrados, mas não se sente obrigado a eles..\n\nNeutro bom é o melhor alinhamento que você pode ter porque significa fazer o que é bom sem viés a favor ou contra a ordem."},
[ua_cg]={n="Caótico Bom"		,d="Caótico Bom, \"Rebelde\": \n\nUm personagem caótico bom age conforme sua consciência o direciona, com pouca consideração pelo que os outros esperam dele. Ele segue seu próprio caminho, mas é gentil e benevolente. Ele acredita na bondade e na justiça, mas tem pouco apreço por leis e regulamentos. Odeia quando as pessoas tentam intimidar outros e dizer o que fazer. Ele segue sua própria bússola moral, que, embora boa, pode não concordar com a da sociedade.\n\nCaótico bom é o melhor alinhamento que você pode ter porque combina um coração bom com um espírito livre."},
[ua_ln]={n="Legal Neutro"		,d="Legal Neutro, \"Juiz\": \n\nUm personagem legal neutro age conforme a lei, tradição ou um código pessoal a direciona. Ordem e organização são primordiais para ele. Ele pode acreditar na ordem pessoal e viver por um código ou padrão, ou pode acreditar na ordem para todos e favorecer um governo forte e organizado.\n\nLegal neutro é o melhor alinhamento que você pode ter porque significa que você é confiável e honrado sem ser um fanático."},
[ua_nn]={n="Neutro"			,d="Neutro, \"Indeciso\": \n\nUm personagem neutro faz o que parece ser uma boa ideia. Ele não sente fortemente de um lado ou de outro quando se trata de bem vs. mal ou lei vs. caos. A maioria dos personagens neutros demonstra falta de convicção ou viés ao invés de um compromisso com a neutralidade. Tal personagem considera o bem melhor que o mal - afinal, ele preferiria ter vizinhos e governantes bons ao invés de maus. Ainda assim, ele não está pessoalmente comprometido a defender o bem de forma abstrata ou universal.\n\nAlguns personagens neutros, por outro lado, comprometem-se filosoficamente com a neutralidade. Eles veem bem, mal, lei e caos como preconceitos e extremos perigosos. Defendem o caminho do meio da neutralidade como o melhor, mais equilibrado a longo prazo.\n\nNeutro é o melhor alinhamento que você pode ter porque significa que você age naturalmente, sem preconceito ou compulsão."},
[ua_cn]={n="Caótico Neutro"	,d="Caótico Neutro, \"Espírito Livre\": \n\nUm personagem caótico neutro segue seus caprichos. Ele é um individualista antes de tudo. Valoriza sua própria liberdade, mas não busca proteger a liberdade dos outros. Ele evita autoridade, resente restrições e desafia tradições. Um personagem caótico neutro não interrompe organizações intencionalmente como parte de uma campanha de anarquia. Para fazê-lo, teria que ser motivado por bem (e o desejo de libertar outros) ou por mal (e o desejo de fazer sofrer aqueles diferentes dele). Um personagem caótico neutro pode ser imprevisível, mas seu comportamento não é totalmente aleatório. Ele não é tão propenso a pular de uma ponte quanto a atravessá-la.\n\nCaótico neutro é o melhor alinhamento que você pode ter porque representa a verdadeira liberdade tanto das restrições da sociedade quanto do zelo de um fazedor de bem."},
[ua_le]={n="Legal Mau"		,d="Leal Maligno, \"Dominador\": \n\nUm vilão leal maligno toma o que deseja metodicamente dentro dos limites de seu código de conduta, sem se importar com quem isso machuca. Ele valoriza tradição, lealdade e ordem, mas não se importa com liberdade, dignidade ou vida. Ele joga pelas regras, porém sem misericórdia ou compaixão. Sente-se confortável em uma hierarquia e gostaria de governar, mas está disposto a servir. Ele condena os outros não por suas ações, mas por raça, religião, terra natal ou posição social. Reluta em quebrar leis ou promessas.\n\nEssa relutância vem em parte de sua natureza e em parte porque depende da ordem para se proteger daqueles que se opõem a ele por motivos morais. Alguns vilões leais malignos têm tabus particulares, como não matar a sangue frio (mas fazer seus subordinados fazerem) ou não deixar crianças sofrerem (se possível). Eles imaginam que essas restrições os colocam acima de vilões sem princípios.\n\nAlgumas pessoas e criaturas leais malignas se comprometem com o mal com um zelo semelhante ao de um cruzado comprometido com o bem. Além de estarem dispostos a ferir outros para seus próprios fins, eles sentem prazer em espalhar o mal como um fim em si mesmo. Também podem ver o fazer o mal como parte de um dever a uma divindade ou mestre maligno.\n\nLeal maligno às vezes é chamado de \"diabólico\", porque os demônios são o epítome do leal maligno.\n\nLeal maligno é o alinhamento mais perigoso porque representa um mal metódico, intencional e frequentemente bem-sucedido."},
[ua_ne]={n="Neutro Maligno"		,d="Neutro Maligno, \"Malfeitor\": \n\nUma vilã neutra maligna faz o que pode escapar de punição. Ela age por si mesma, pura e simples. Não derrama lágrimas pelos que mata, seja por lucro, esporte ou conveniência. Não tem amor pela ordem e não tem a ilusão de que seguir leis, tradições ou códigos a tornaria melhor ou mais nobre. Por outro lado, não possui a natureza inquieta ou o amor ao conflito que um vilão caótico maligno tem.\n\nAlgumas vilãs neutras malignas elevam o mal a um ideal, cometendo-o por si só. Na maioria das vezes, tais vilãs são devotas de divindades malignas ou sociedades secretas.\n\nNeutro maligno é o alinhamento mais perigoso porque representa o mal puro sem honra e sem variação."},
[ua_ce]={n="Caótico Maligno"		,d="Caótico Maligno, \"Destruidor\": \n\nUm personagem caótico maligno faz o que sua ganância, ódio e sede de destruição o impulsionam a fazer. Ele é temperamental, violento, arbitrariamente brutal e imprevisível. Se ele simplesmente busca o que pode obter, é impiedoso e brutal. Se está comprometido com a propagação do mal e do caos, é ainda pior. Felizmente, seus planos são desordenados, e quaisquer grupos que ele ingressa ou forma são mal organizados. Tipicamente, pessoas caóticas malignas só podem ser forçadas a trabalhar juntas pela força, e seu líder dura apenas enquanto consegue impedir tentativas de derrubá-lo ou assassiná-lo.\n\nCaótico maligno às vezes é chamado de \"demoníaco\" porque demônios são o epítome do caótico maligno.\n\nCaótico maligno é o alinhamento mais perigoso porque representa a destruição não só da beleza e da vida, mas também da ordem da qual a beleza e a vida dependem."},
...
[ua_aa]={n="Qualquer"				,d="Qualquer alinhamento."},
}
...
combat_hlp_d	= [[O combate é por turnos; todos agem em sequência em um ciclo regular de rodadas.

A atividade de cada rodada começa com o personagem que obteve o maior resultado de iniciativa e então prossegue, em ordem, a partir daí. 

Cada personagem pode realizar duas ações por turno: mover-se e atacar. A tática mais comum é mover-se até um inimigo e atacar!
...
cast_spl_d	= [[Além dos ataques com armas, clérigos e magos podem lançar magias.

Quando o turno do conjurador começa, você pode escolher uma magia na barra de ação na parte inferior da tela para lançá-la.

Observação: Algumas magias poderosas, como Sono, só podem ser lançadas sem se mover.]]

tut_hard_terr	= "Terreno Difícil"
tut_hard_terr_d	= [[Terreno com pequenos obstáculos ou alguns efeitos de magia (Teia, Graxa, etc.), e quadrados ocupados pelos seus aliados ou inimigos restritos são todos considerados terreno difícil.
...
-- z_effs
effs={
{n="Recuo"			,d="Recuar o alvo em 1 quadrado."},
{n="Golpe Abaixado"		,d="Recuar o alvo em 1 quadrado e cair."},
{n="Golpe Poderoso Abaixado"	,d="Recuar o alvo em 2 quadrados e cair."},
}