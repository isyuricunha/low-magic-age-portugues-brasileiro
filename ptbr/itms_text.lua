...
bounce_p		= {n="Espinhoso"						,d="Atacantes corpo a corpo recebem pouco dano perfurante ao te acertarem", f="Atacantes corpo a corpo recebem %s de dano perfurante ao te acertarem"}
bounce_f		= {n="Escudo de Fogo"					,d="Atacantes corpo a corpo recebem pouco dano de fogo ao te acertarem", f="Atacantes corpo a corpo recebem %s de dano de fogo ao te acertarem"}
ctr_atk			= {n="Contra-ataque"				,d="Quando seus inimigos erram você com ataques corpo a corpo, você tem uma chance de contra-atacar.", f="Quando seus inimigos erram você com ataques corpo a corpo, você tem %d%% de chance de contra-atacar."}
...
hr				= {n="Regenerando"					,d="Regenera alguns pontos de vida por turno", f="Regenera %d pontos de vida por turno"}
...
auto_heal2		= {n="Cura própria maior"			,d="Recupera alguns pontos de vida automaticamente ao ficar sangrando pela primeira vez", f="Recupera %d pontos de vida automaticamente ao ficar sangrando pela primeira vez"}
...
elm_dmg			= {n="Aprimoramento Elemental"		,d="Melhora o dano elemental das magias", f="%+d dano em magias elementais"}
pe_dmg			= {n="Aprimoramento de Energia Positiva"	,d="Melhora o dano de energia positiva das magias", f="+%d dano em magias de energia positiva"}
ne_dmg			= {n="Aprimoramento de Energia Negativa"	,d="Melhora o dano de energia negativa das magias", f="+%d dano em magias de energia negativa"}
...
unsr			= {n=s_unsr							,d=s_unsr_d	,f="%+d penetração de magias"}
...
s_ie_fire		= {n="Flamejante"			,f="+%s dano de fogo"}
s_ie_cold		= {n="Gélido"			,f="+%s dano de frio"}
s_ie_shock		= {n="Choque"			,f="+%s dano de eletricidade"}
s_ie_acid		= {n="Ácido"				,f="+%s dano de ácido"}
s_ie_def		= {n="Defendendo"		,f="%+d bônus de escudo na CA (apenas corpo a corpo)"}
...
s_ie_bleed		= {n="Feridor"			,f="Faz o alvo sangrar (%d dano por rodada, acumulável)"}
s_ie_kill_ud	= {n="Disrupção"		,f="Alvo morto-vivo deve ter sucesso em um teste de Turn ou ser destruído"}
s_ie_destroy	= {n="Destruição"		,f="+%s dano de arma"}
s_ie_kill		= {n="Mortal"			,f="%d%% chance de matar o alvo"}
s_ie_vampire	= {n="Vampiro"			,f="Sanguessugas %s pontos de vida"}
s_ie_good		= {n="Sagrado"				,f="+%s dano de arma contra o mal"}
s_ie_evil		= {n="Profano"			,f="+%s dano de arma contra o bem"}
s_ie_law		= {n="Axiomático"		,f="+%s dano de arma contra o caótico"}
s_ie_chaos		= {n="Anárquico"			,f="+%s dano de arma contra leal"}
...
s_ie_imm_tox	= {n="Pureza"			,f="Imune a dano de veneno e efeito"}
...
s_ie_elm_w		= {n="Elemental de Água"	}
...
s_ie_trip		= {n="Trip Automático"		,f="Aciona teste de queda ao acertar"}
s_ie_palsy		= {n="Paralisia"		,f="Alvo deve ter sucesso em um teste de resistência de fortitude ou ficar paralisado"}
...
Arcos, bestas e fundas assim fabricados concedem a energia sônica à sua munição.
...
s_ie_behead		="Vorpal"	s_ie_behead_d	=[[Esta habilidade potente e temida permite que a arma corte as cabeças daqueles que ela atinge. Ao rolar um natural 20 (seguido de uma rolagem bem-sucedida para confirmar o crítico), a arma corta a cabeça do oponente (se ele tiver uma) de seu corpo.

Algumas criaturas, como muitas aberrações e todos os gosmas, não têm cabeças. Outras, como golems e criaturas mortas-vivas que não sejam vampiros, não são afetadas pela perda de suas cabeças. A maioria das demais criaturas, porém, morre quando suas cabeças são cortadas.
...
s_skls_cha		="Homem Sem Rosto"		s_skls_abi_d	="Aumente o rank base das seguintes perícias para o nível do personagem (se for menor)"
s_skls_knw		="Arqui-Sábio"		s_skls_knw_d	="Aumente o rank base de todas as perícias de Conhecimento para o nível do personagem (se for menor)"
s_skls_pfm		="Deusa da Canção"	s_skls_pfm_d	="Aumente o rank base de todas as perícias de Atuação para o nível do personagem (se for menor)"

s_ie_imx_flk	="Presciência"				s_ie_imx_flk_d		="Não pode ser flanqueado"
s_ie_imx_dex	="Intuição"				s_ie_imx_dex_d		="Mantém o bônus de Destreza à classe de armadura mesmo quando desprevenido, exceto se imobilizado."
...
s_ie_unrng1		="Armadilha de Flecha Menor"		s_ie_unrng1_d		="Uma vez por combate, anula um ataque de arma à distância."
s_ie_unrng2		="Armadilha de Flecha Aprimorada"	s_ie_unrng2_d		="Uma vez por rodada, anula um ataque de arma à distância."
...
s_ie_dwf		="Anão"				s_ie_dwf_d			="Raças não-anãs ganham: visão no escuro de 60 pés, astúcia de pedra anã, %+d bônus de aprimoramento de Constituição, %+d bônus de resistência em testes contra veneno, magias ou efeitos semelhantes a magias."
s_ie_elf		="Elfo"				s_ie_elf_d			="Raças não-elfas ganham: visão em luz baixa, imunidade a efeitos de sono mágico, %+d bônus de aprimoramento de Destreza, %+d bônus de teste de resistência contra magias ou efeitos de encantamento."
...
s_ie_sickened	="Enfraquecido"					s_ie_sickened_d		="Uma vez por rodada, todos os inimigos a até 30 pés ficam enfraquecidos por 1-3 rodadas (Teste de Fortitude CD %d)."
...
s_mat_eqpts		="Equipamento de Material Especial"	s_mat_eqpts_d	="Equipamento feito com materiais especiais tem propriedades e efeitos especiais, como peso mais leve ou ignorar a redução de dano de algumas criaturas."

s_alch_slvr		="Prata Alquímica"
s_bond_slvr		="Prata Vinculada"	s_bond_slvr_d	="Um processo complexo envolvendo metalurgia e alquimia pode ligar prata a uma arma feita de ferro/acô para que ela ignore a redução de dano de criaturas como licantropos. Mas o portador recebe uma penalidade de -1 nos rôl de dano de armas prateadas.\n\nO processo de prata alquimica não pode ser aplicado a itens não metálicos, e não funciona em metais raros como adamantina e mithral."
...
- A chance de falha de magia para armaduras e escudos de mithral é reduzida em 10%, o bônus máximo de Destreza é aumentado em 2, e a penalidade de teste de armadura é reduzida em 3.
...
s_dkwd_d		=[[Esta madeira mágica rara é tão dura quanto madeira normal, mas muito leve.

- Itens de madeira sombria são sempre itens de obra-prima.
- Itens de madeira sombria pesam metade do normal.
- A penalidade de teste de armadura de escudos de madeira sombria é reduzida em 2.
...
s_mith_h		=[[Mithral é um metal muito raro, prateado e reluzente, que é mais leve que o ferro, mas tão duro quanto. Quando trabalhado como aço, torna-se um material maravilhoso para criar armaduras e ocasionalmente é usado para outros itens também. Armas ou armaduras feitas de mithral são sempre itens de obra-prima. A maioria das armaduras de mithral é uma categoria mais leve que o normal para fins de movimento e outras limitações. Armaduras pesadas são tratadas como médias, e armaduras médias são tratadas como leves, mas armaduras leves continuam sendo leves. As chances de falha de magia para armaduras e escudos feitos de mithral são reduzidas em 10%, o bônus máximo de Destreza é aumentado em 2, e as penalidades de teste de armadura são reduzidas em 3 (para um mínimo de 0).

Um item feito de mithral pesa metade do que o mesmo item feito de outros metais. No caso de armas, esse peso mais leve não altera a categoria de tamanho da arma nem a facilidade com que pode ser manejada (seja leve, de uma mão ou de duas mãos). Itens que não são principalmente de metal não são significativamente afetados por serem parcialmente feitos de mithral. (Um espadão pode ser uma arma de mithral, enquanto uma foice não pode ser.)
...
s_adam_h		=[[Este metal ultraduro aumenta a qualidade de uma arma ou armadura.
...
s_dkwd_h		=[[Esta madeira mágica rara é tão dura quanto madeira normal, mas muito leve. Qualquer item de madeira ou quase totalmente de madeira (como um arco, uma flecha ou uma lança) feito de madeira sombria é considerado um item de obra-prima e pesa apenas metade do que um item de madeira normal desse tipo pesa. A penalidade de teste de armadura de um escudo de madeira sombria é reduzida em 2 comparado a um escudo comum do mesmo tipo.
...
Para determinar o preço de um item de madeira sombria, use o peso original mas adicione 10 gp por libra ao preço de uma versão de obra-prima desse item.]]
s_cdir_h		=[[]]
...
[itm_mat_dkcl	]={n="Pano de Folha Sombria	"},
...
d_simple_tools	= [[Usar as perícias Desativar Dispositivo e Abrir Fechadura requer ao menos uma ferramenta simples do tipo apropriado (um gancho, barra de alavanca, chave em branco, fio ou similar) ou um conjunto de ferramentas de ladrão.
...
d_thieves_tools	= [[Este kit contém as ferramentas necessárias para usar as perícias Desativar Dispositivo e Abrir Fechadura. O kit inclui uma ou mais chaves-esqueleto, longas ferramentas de metal e alavancas, uma pinça de bico longo, uma pequena serra manual e uma pequena cunha e martelo.
...
d_lockpick		= [[Além de um conjunto de ferramentas simples ou ferramentas de ladrão, também são necessárias gazuas para arrombar fechaduras. Ao contrário de outras ferramentas, as gazuas são mais facilmente danificadas. Portanto, aventureiros experientes sempre carregam um número extra de gazuas.]]
...
tshd_penalty	= "Ao usar um escudo torre em combate, você recebe penalidade de -2 nas rolagens de ataque (mesmo sendo proficiente nele) devido ao peso do escudo."
...
{n="Pedra preciosa"				,d="Como materiais preciosos, pedras preciosas podem ser usadas em uma variedade de artesanatos."																				},
{n="Minério"					,d="Minério é um material bruto comum que pode ser fundido no tipo de metal homólogo."																},
{n="Metal"					,d="O metal é fundido a partir do tipo de minério homólogo. É um dos materiais básicos para a fabricação de armas e armaduras."									},
{n="Madeira"					,d="A madeira é um material base comum que pode ser usado para a fabricação de armas e também pode ser usado como combustível."												},
{n="Combustível"					,d="O combustível é um dos materiais brutos básicos para fundição e forja."																				},
{n="Tecido"					,d="O tecido é um dos principais materiais para a confecção de armaduras. Mesmo que algumas armaduras sejam feitas de metal, elas precisam de pequenos pedaços de tecido como forro."		},
{n="Couro"				,d="O couro é usado principalmente para fazer armaduras de couro. Alguns outros tipos de armadura também requerem uma pequena quantidade de couro para fazer juntas ou decorações."		},
...
{n="Duplo-cabeça"	,a="DB"},-- Double
}

-- weapon groups z_wpn_grp
wpn_grps={
{n="Lâmina Leve"	,d="Lâminas leves recompensam a precisão tanto quanto a força. Ataques precisos, investidas e defesas ágeis são os pontos fortes dessas armas."},
{n="Lâmina Pesada"	,d="Lâminas são armas de lâmina equilibrada. Lâminas pesadas combinam parte da precisão das lâminas leves e parte da massa dos machados. Lâminas pesadas são usadas principalmente para cortes de golpe em vez de estocadas e perfurações."},--{n="Sword"		,d="Swords are most popular weapons. Balanced edged, can be used for slashing cuts, thrusts and pinpoint attacks."},
{n="Machado"			,d="Machados têm cabeças de lâmina pesada e causam cortes ferozes."},
{n="Picareta"			,d="Com peso concentrado na parte superior como uma maça ou um machado, a picareta tem uma cabeça longa e pontiaguda feita para perfurar e causar feridas profundas."},
...
{n="Mangual"			,d="Armas de mangual têm um material flexível, geralmente uma corrente, entre um cabo sólido e a extremidade que causa dano."},
...
{n="Desarmado"		,d="Quando você soca, chuta, dá cotovelada, joelhada ou até cabeçada em um oponente, está realizando um ataque desarmado. Criaturas que possuem armas naturais, como garras ou mordidas, são proficientes com essas armas naturais."},
...
{n="Alcance"			,d="Pode ser usado para atacar oponentes dentro de 2 quadrados, mas funciona como outras armas corpo a corpo ao fazer ataques de oportunidade ou flanquear."},
...
{n="Leve"			,d="Com o talento Finesse de Arma, pode usar Destreza ao invés de Força nas rolagens de ataque. Mais fácil de usar na mão secundária, mas sem vantagem quando usado com duas mãos."},
{n="Finesse"		,d="Muito semelhante a armas leves, mas não muito eficaz na mão secundária."},
{n="Carga"			,d="+1 de bônus nas rolagens de ataque e dano de cargas."},
{n="Derrubar"			,d="+2 de bônus em ataques de derrubar, e não provoca ataques de oportunidade do alvo ao derrubar."},
{n="Arremesso Leve"	,d="Faça ataques à distância baseados em Destreza."},
{n="Arremesso Pesado"	,d="Use Força ao invés de Destreza nas rolagens de ataque e dano."},
...
{n="Monge"			,d="Esta designação concede a um monge que empunha a arma opções especiais."},
}
...
s_h4_wpn		="Arma Dupla"				s_h4_wpn_d		="Pode ser usado como se estivesse lutando com duas armas (arma de uma mão + arma leve) ou empunhado em uma mão (arma de uma mão)."
s_fly_back		="Retorno ao ar"						s_fly_back_d	="Armas arremessáveis mágicas retornam automaticamente sem consumo."
s_bow_cs		="Composto"					s_bow_cs_d		="Aplica bônus de Força nas rolagens de dano com arcos."
...
s_cft			="Fabricar"						s_cft_d			="Fabrique itens mágicos melhores, equipamentos de material especial, arcos compostos e bestas guiadas por magia, etc."

s_lmt_itms		="Itens Limitados"				s_lmt_itms_d	="Vários equipamentos mágicos, itens maravilhosos e poções, etc."
s_wond_itms		="Itens Maravilhosos"				s_wond_itms_d	="Cintos mágicos, faixas de cabeça, capas, vestes, luvas/munhequeiras, botas, amuletos, anéis, acessórios e muito mais."
...
s_amms			="Munições"					s_amms_d		="Flechas, virotes e projéteis de funda para arcos, bestas e fundas."
s_eqpts_ee		="Equipamento Encantado"			s_eqpts_ee_d	="Equipamento mágico com encantamentos aleatórios."
s_cft_ee		="Fabricar Equipamento Encantado"	s_cft_ee_d		="Anexe encantamentos aleatórios a equipamentos mágicos. Os encantamentos originais (se houver) serão removidos."
s_cft_mw2		="Fabricar Equipamento de Qualidade Superior"	s_cft_mw2_d		="Refaça equipamentos mundanos em equipamentos de qualidade superior."
s_cft_e0		="Fabricar Equipamento Mágico"		s_cft_e0_d		="Encante equipamentos mundanos ou de qualidade superior em equipamentos mágicos, ou aumente o bônus mágico de equipamentos mágicos existentes (limitado pelo nível do grupo)."
...
s_cft_csbow		="Fabricar Arcos Compostos"			s_cft_csbow_d	="Anexe partes compostas a arcos."
s_cft_mxbow		="Fabricar Bestas Guiadas por Magia"	s_cft_mxbow_d	="Anexe partes guiadas por magia a bestas."
...
s_cft_lk_ee		="Encantamento de Trava"				s_cft_lk_ee_d	="Ao reencantar, os encantamentos bloqueados permanecem."

s_eqpts			="Equipamento"	s_eqpts_d	=[[Armas, armaduras e outros equipamentos mágicos usados por um personagem afetarão todos os aspectos de suas habilidades.

No mercado de uma grande cidade, ferreiros de armaduras e de armas oferecem uma grande variedade de armas e armaduras para quem tem ouro para comprá-las. Aqui você pode encontrar espadas práticas e robustas e talvez algumas lâminas élficas de qualidade excepcional.
...
As armas são agrupadas em vários conjuntos interligados de categorias. Essas categorias referem-se ao treinamento necessário para se tornar proficiente no uso de uma arma (simples, marcial ou exótica), à utilidade da arma tanto em combate corpo a corpo (corpo a corpo) quanto à distância (a distância, que inclui armas arremessáveis e projéteis), ao seu peso relativo (leve, de uma mão ou de duas mãos) e ao seu tamanho (Pequeno, Médio ou Grande).


<c=ty b>Armas Simples, Marcial e Exóticas: </c><z>Qualquer pessoa exceto um druida, monge, ladino ou mago é proficiente com todas as armas simples. Bárbaros, combatentes, paladinos e guardiões são proficientes com todas as armas simples e todas as armas marciais. </z>Personagens de <z>outras</z>maiores classes são proficientes com um conjunto principalmente de armas simples e possivelmente também algumas armas marciais ou até exóticas. Um personagem que usa uma arma com a qual não é proficiente recebe penalidade de -4 nas rolagens de ataque.
...
<c=ty>Armas de Alcance: </c>Glaives, guisarmes, lanças, longas lanças, ranseurs, correntes com espinhos e chicotes são armas de alcance. Uma arma de alcance é uma arma corpo a corpo que permite ao seu portador atingir alvos que não estão adjacentes a ele. A maioria das armas de alcance dobra o alcance natural do portador, significando que um portador Pequeno ou Médio típico de tal arma pode atacar uma criatura a 10 pés de distância<z>, mas não uma criatura em um quadrado adjacente. Um personagem Grande típico empunhando uma arma de alcance do tamanho adequado pode atacar uma criatura a 15 ou 20 pés de distância</z>.

<c=ty>Armas Duplas: </c>Mangas de ferro, urgroshes anões, martelos de gancho gnômicos, machados duplos orcs, bastões curtos e espadas de duas lâminas são armas duplas. Um personagem pode lutar com ambas as extremidades de uma arma dupla como se estivesse lutando com duas armas, mas sofre todas as penalidades normais de ataque associadas ao combate com duas armas, como se estivesse empunhando uma arma de uma mão e uma arma leve.

O personagem também pode escolher usar uma arma dupla com duas mãos, atacando apenas com uma extremidade dela. Uma criatura que empunha uma arma dupla em uma mão não pode usá-la como arma dupla - apenas uma extremidade da arma pode ser usada em cada rodada.

<c=ty>Armas Arremessáveis: </c>Adagas, porretes, curtas lanças, lanças, dardos, javelins, machados arremessáveis, martelos leves, tridentes, shuriken e redes são armas arremessáveis. O portador aplica seu modificador de Força ao dano causado por armas arremessáveis<z> (exceto para armas de efeito em área). É possível arremessar uma arma que não foi projetada para ser arremessada (ou seja, uma arma corpo a corpo que não possui um valor numérico na coluna Incremento de Alcance na Tabela: Armas), mas um personagem que o faz recebe penalidade de -4 na rolagem de ataque. Arremessar uma arma leve ou de uma mão é uma ação padrão, enquanto arremessar uma arma de duas mãos é uma ação de rodada completa. Independentemente do tipo de arma, esse ataque só gera ameaça em um resultado natural de 20 e causa dano dobrado em um acerto crítico. Tal arma tem um incremento de alcance de 10 pés</z>.

<c=ty>Armas de Projétil: </c>Arcos curtos leves, fundas, arcos pesados, arcos curtos, arcos curtos compostos, arcos longos, arcos longos compostos, arcos de mão e arcos repetidores são armas de projétil. A maioria das armas de projétil requer duas mãos para ser usada (veja as descrições específicas das armas). Um personagem não recebe bônus de Força nas rolagens de dano com uma arma de projétil, a menos que seja um arco curto composto especialmente construído, um arco longo composto especialmente construído ou uma funda. Se o personagem tem penalidade por Força baixa, aplique-a nas rolagens de dano quando ele usar um arco ou uma funda.

<c=ty>Munição: </c>Armas de projétil usam munição: flechas (para arcos), virotes (para arcos de cruz) ou balas de funda (para fundas).<z> Ao usar um arco, um personagem pode puxar munição como ação livre; arcos de cruz e fundas requerem uma ação para recarregar.</z> Geralmente, munição que atinge seu alvo é destruída ou inutilizada, enquanto munição normal que erra tem uma chance de 50% c% de ser destruída ou perdida.
...
<c=ty>De Duas Mãos: </c>São necessárias duas mãos para usar efetivamente uma arma corpo a corpo de duas mãos. Aplique 1,5 vezes o bônus de Força do personagem às rolagens de dano para ataques corpo a corpo com tal arma.
...
Armas Improvisadas: Às vezes objetos que não foram fabricados como armas ainda são usados em combate. Como tais objetos não foram projetados para esse uso, qualquer criatura que use um em combate é considerada não-proficiente com ele e recebe penalidade de -4 nas rolagens de ataque feitas com esse objeto. Para determinar a categoria de tamanho e o dano adequado de uma arma improvisada, compare seu tamanho relativo e potencial de dano com a lista de armas para encontrar uma correspondência razoável. Uma arma improvisada gera ameaça em um resultado natural de 20 e causa dano dobrado em um crítico. Uma arma improvisada arremessável tem um incremento de alcance de 10 pés.</z>


<h2 c=ty>Qualidades das Armas</h2>
A arma que você usa diz algo sobre quem você é. Provavelmente você quer equipar-se com uma arma corpo a corpo e uma arma à distância. Se não puder pagar ambas, decida qual é mais importante para você.

O tamanho da arma que você escolhe determina como pode empunhá-la (com uma mão ou duas) e quanto dano pode causar com ela. Uma arma de duas mãos causa mais dano que uma arma de uma mão, mas empunhar uma arma de duas mãos impede o portador de usar um escudo, portanto há um trade-off.

O número de armas com as quais você é proficiente depende da sua classe e raça. Você também pode se tornar proficiente com armas adicionais escolhendo os talentos corretos.

Uma arma melhor costuma ser mais cara que uma inferior, mas mais cara nem sempre significa melhor. Por exemplo, um rapiers é mais caro que uma espada longa. Para um ladino ágil com o talento Finesse com Arma, um rapiers é uma arma excelente. Para um combatente típico, uma espada longa é melhor.
...
Em outros casos, uma arma pode causar um ou outro dos dois tipos de dano. Quando o tipo de dano é relevante, o portador pode escolher qual tipo de dano infligir com tal arma (escolhendo automaticamente o melhor no jogo).
...
Por exemplo:
5%/x2 (ou x2): A arma gera um acerto crítico em um resultado natural de 20 e causa dano dobrado em um crítico.
10%/x3 (ou 19-20/x3): A arma gera um acerto crítico em um resultado natural de 19 ou 20 (em vez de apenas 20) e causa dano triplo em um crítico.
...
Para usar armaduras mais pesadas de forma eficaz, um personagem pode selecionar os talentos de Proficiência em Armadura, mas a maioria das classes já é automaticamente proficiente nas armaduras que melhor se adequam a elas.]]
...
<b c=ty>Bônus Máximo de Destreza:</b> Esse número é o bônus máximo de Destreza à classe de armadura que este tipo de armadura permite. Armaduras mais pesadas limitam a mobilidade, reduzindo a capacidade do usuário de desviar de golpes. Essa restrição não afeta nenhuma outra habilidade relacionada à Destreza.

O peso carregado do seu personagem (a quantidade de equipamento que ele ou ela carrega) também pode restringir o bônus máximo de Destreza que pode ser aplicado à sua classe de armadura.
...
O peso carregado de um personagem (a quantidade de equipamento carregado, incluindo armadura) também pode aplicar uma penalidade de verificação de armadura.

<b>Escudos:</b> Se um personagem está usando armadura e escudo, ambas as penalidades de verificação de armadura se aplicam.


<b c=ty>Chance de Falha de Magia Arcana:</b> A armadura interfere nos gestos que um conjurador deve fazer para lançar uma magia arcana que possui componente somático. Conjuradores arcanos enfrentam a possibilidade de falha de magia arcana se estiverem usando armadura.

<b>Lançando uma Magia Arcana em Armadura:</b> Um personagem que lança uma magia arcana enquanto usa armadura normalmente deve fazer uma rolagem de falha de magia arcana. A Chance de Falha de Magia Arcana de Armaduras e Escudos é a chance de que a magia falhe e seja arruinada.

<b>Escudos:</b> Se um personagem está usando armadura e escudo, some os dois números para obter uma única chance de falha de magia arcana.
...
<b c=ty>Peso:</b> O peso da armadura dimensionada para um usuário Médio. Armaduras ajustadas para personagens Pequenos pesam metade, e armaduras para personagens Grandes pesam o dobro.]]

s_norm_eqpts	="Equipamento de Obra-Prima"	s_norm_eqpts_d	=[[Equipamento comum inclui armas básicas, armaduras e escudos.
...
s_mw_eqpts		="Equipamento de Obra-Prima"	s_mw_eqpts_d	=[[Uma arma ou armadura de obra-prima é uma versão finamente trabalhada da versão normal, porém com melhor qualidade e preço mais alto.

Uma arma de obra-prima fornece um bônus de aprimoramento de +1 nas rolagens de ataque.
...
s_mw_eqpts_h	=[[Uma arma ou armadura de obra-prima é uma versão finamente trabalhada da versão normal, porém com melhor qualidade e preço mais alto.


<h2 c=ty>Armas de Obra-Prima</h2>
Uma arma de obra-prima fornece um bônus de aprimoramento de +1 nas rolagens de ataque.

A qualidade de obra-prima adiciona 300 gp ao custo de uma arma normal (ou 6 gp ao custo de uma única unidade de munição).

O bônus de aprimoramento da munição de obra-prima não se acumula com nenhum bônus de aprimoramento da arma de projétil que a dispara.

Todas as armas mágicas são automaticamente consideradas de qualidade obra-prima. O bônus de aprimoramento concedido pela qualidade obra-prima não se acumula com o bônus de aprimoramento fornecido pela magia da arma.


<h2 c=ty>Armaduras de Obra-Prima</h2>
A versão de obra-prima de armaduras ou escudos funciona como a versão normal, exceto que sua penalidade de verificação de armadura é reduzida em 1.

Um conjunto de armadura ou escudo de obra-prima custa 150 gp a mais além do custo normal desse tipo de armadura ou escudo.

Todas as armaduras e escudos mágicos são automaticamente considerados de qualidade obra-prima.]]
...
<b c=ty>Armadura e Escudos:</b> Armadura mágica (incluindo escudos) oferece proteção mágica aprimorada ao usuário. Alguns desses itens conferem habilidades além de um benefício à classe de armadura.

<b c=ty>Armas:</b> Armas mágicas são criadas com uma variedade de poderes de combate e quase sempre melhoram as rolagens de ataque e dano do portador também.

<b c=ty>Poções:</b> Uma poção é um elixir preparado com um efeito semelhante a uma magia que afeta apenas quem a bebe.

<b c=ty>Itens Maravilhosos:</b> Esses objetos incluem cintos mágicos, faixas de cabeça, capas, mantos, luvas/braçadeiras, botas, amuletos, anéis, acessórios e muito mais.
...
Muitos itens mágicos precisam ser vestidos por um personagem que deseja utilizá-los ou beneficiar-se de suas habilidades. É possível para uma criatura com corpo humanoide usar até onze itens mágicos ao mesmo tempo. Contudo, cada um desses itens deve ser usado (ou sobre) uma parte específica do corpo.


Um corpo humanoide pode ser equipado com equipamentos mágicos consistindo de um item de cada um dos seguintes grupos, de acordo com a parte do corpo onde o item é usado.
...
- Um cinto na cintura (sobre uma túnica ou conjunto de armadura)
- Uma capa, manto ou capa nos ombros (sobre uma túnica ou conjunto de armadura)
...
Claro, um personagem pode carregar ou possuir quantos itens do mesmo tipo desejar. Ele pode ter um bolso cheio de anéis mágicos, por exemplo. Mas ele só pode se beneficiar de dois anéis ao mesmo tempo. Se ele colocar um terceiro anéis, ele não funciona.

Esta regra geral se aplica a outras tentativas de "dobrar" itens mágicos - por exemplo, se um personagem colocar outra capa mágica sobre a que já está usando, o poder da segunda capa não funciona.]]
...
sting				="Fura com um ferrão, causando dano perfurante. Normalmente causa dano de veneno além do dano aos pontos de vida."
tail				="Bate com uma cauda poderosa, causando dano contundente."
fang				="Fura com uma presa afiada, causando dano perfurante. Normalmente causa dano de veneno além do dano aos pontos de vida."
lich_tough			="Ataque de toque corpo a corpo, causando toneladas de dano não tipado. O alvo deve ter sucesso em um teste de resistência de Fortitude ou ficar permanentemente paralisado."
s_itm_talons		="Garras"
...
s_itm_hooves		="Casco"
s_itm_hooves_d		=slam
s_itm_stamps		="Pisoteios"
s_itm_stamps_d		="Pisoteia com suas pernas fortes, causando dano contundente."
s_itm_tentacles		="Tentáculos"
s_itm_tentacles_d	="Flangeia com um tentáculo poderoso, causando dano contundente (e às vezes cortante)."
s_itm_ram			="Aríete"
s_itm_ram_d			="Impacta com uma parte de seu corpo, causando dano contundente."
...
bow_cmn_d	="Você precisa de pelo menos duas mãos para usar um arco, independentemente do seu tamanho.\n\nSe você tem penalidade por Força baixa, aplique-a às rolagens de dano ao usar um arco. Se você tem bonuço por Força alta, pode aplicá-lo às rolagens de dano ao usar um arco composto, mas não a um arco comum.\n\nArcos usam flechas como munição."
...
ioun_d		="Pedras mágicas raras e preciosas que podem ser usadas para conter vários encantamentos."
...
ring_er_d	="Estes anéis protegem continuamente seus usuários de dano de todos os tipos de energia."
ring_unsr_d	="Um anel apropriativo para conjuradores arcanos, pode neutralizar a resistência a magia do alvo."
...
{n="Rapier",			d="Uma espada longa, esguia e de duas lâminas com empunhadura em forma de copo."},
...
{n="Espada longa",			d="Uma espada longa (também escrita long sword, long-sword) é um tipo de espada caracterizada por ter uma empunhadura cruciforme com um cabo para uso com duas mãos e uma lâmina reta de duas faces.\n\nEsta lâmina clássica e reta é a arma da cavalaria e do valor. É a arma favorita de muitos paladinos."},
...
{n="Foice",			d="Uma foice construída para combate (em oposição a uma foice de colheita padrão) tem sua lâmina transformada de modo que se estende verticalmente a partir do cabo, e é usada de forma semelhante a uma alabarda."},
...
-- Axe/Pick
{n="Machado de arremesso",		d="Este é um machado pequeno equilibrado para arremesso."},
{n="Machado de batalha",			d="Um machado de batalha (também machado-de-batalha ou machado de batalha) é um machado projetado especificamente para combate. Machados de batalha são versões especializadas de machados utilitários. Muitos são adequados para uso com uma mão, enquanto outros são maiores e usados com duas mãos."},
{n="Machado grande",			d="Um machado muito grande, feito para machucar coisas, gravemente."},
{n="Picareta leve",		d="Um tipo de martelo de guerra com um espinho muito longo na parte reversa da cabeça do martelo. Normalmente esse espinho é ligeiramente curvado para baixo, muito parecido com uma picareta de minerador. É excelente para perfurar armadura espessa ou cota de malha que uma espada teria dificuldade em penetrar."},
...
{n="Martelo de guerra",			d="O martelo de guerra consiste em um cabo e uma cabeça. O cabo pode ter diferentes comprimentos, sendo o mais longo aproximadamente equivalente a uma alabarda, e o mais curto cerca de um mesmo tamanho de uma maça."},
{n="Marreta",				d="Um martelo pesado, usado para cravar estacas ou cunhas. Se seu oponente estiver usando armadura que uma lâmina de espada de aço não consegue penetrar, você ainda pode causar dano esmagando-o com o martelo."},
{n="Clava",				d="Esta arma geralmente é apenas um pedaço de madeira moldado, às vezes com alguns pregos ou pinos embutidos."},
{n="Clava Grande",			d="Esta versão maior e mais volumosa da clava comum é pesada o suficiente para que você não possa manejá-la com uma mão. Pode ser ornamentada e entalhada, reforçada com metal, ou um simples galho de árvore. Como as clavas simples, as clavas grandes têm muitos nomes, como cudgels, bludgeons, shillelaghs e outros."},
...
{n="Lança",				d="Uma lança tem 5 pés de comprimento e pode ser arremessada, consistindo de um cabo longo com uma ponta afiada."},
{n="Lança Longa",			d="Uma lança longa tem cerca de 8 pés de comprimento."..long_wpn_d},
{n="Alabarda",			d="Uma alabarda é semelhante a uma lança de 5 pés de comprimento, mas também possui uma pequena cabeça em forma de machado montada perto da ponta."..long_wpn_d},
-- Bow
{n="Arco Curto",			d="Um arco curto é feito de um único pedaço de madeira, com cerca de 3 pés de comprimento."..bow_cmn_d},
{n="Arco Longo",			d="Com quase 5 pés de altura, um arco longo é feito de um único pedaço de madeira cuidadosamente curvada."..bow_cmn_d},
-- Crossbow
{n="Arco de Mão",		d="Você pode disparar um arco de mão com uma mão sem penalidade. Você pode disparar um arco de mão com cada mão, mas recebe uma penalidade nas jogadas de ataque como se estivesse usando duas armas leves."},
{n="Besta Leve",	d="Operar uma besta leve requer duas mãos. Você recua uma besta leve puxando uma alavanca."},
{n="Besta Pesada",	d="Operar uma besta pesada requer duas mãos. Você recua uma besta pesada girando uma pequena manivela."},
-- Sling
...
{n="Camisa de Correntes",		d="Cobertura do torso, esta camisa é feita de milhares de anéis de metal entrelaçados."},
-- Medium Armor
{n="Cota de Escamas",		d="A cota de escamas é composta por dezenas de pequenas placas de metal sobrepostas. O conjunto inclui manoplas."},
{n="Peitoral",		d="Cobertura apenas do torso, um peitoral é feito de uma única peça de metal esculpido."},
-- Heavy Armor
{n="Meia Armadura de Placas",		d="Combinando elementos de armadura completa e cota de malha, a meia armadura de placas inclui manoplas e um elmo."},
{n="Armadura Completa de Placas",		d="Este traje de metal inclui manoplas, botas de couro pesado, um elmo com viseira e uma espessa camada de acolchoamento que é usada sob a armadura. Cada armadura completa de placas deve ser ajustada individualmente ao seu dono por um mestre armeiro, embora uma armadura capturada possa ser redimensionada para um novo proprietário."},
-- Sheild
{n="Escudo Leve",		d="Você prende um escudo leve ao seu antebraço e o segura com a mão. Você não pode usar a mão do escudo para outra coisa."},
{n="Escudo Pesado",		d="Você prende um escudo pesado ao seu antebraço e o segura com a mão. Você não pode usar a mão do escudo para outra coisa."},
{n="Escudo Torre",		d="Este escudo de madeira maciço tem quase a sua altura."},
...
{n="Cinto Magnífico"							,d="Este cinturão de metal cintilante traz força e poder ao usuário e concede ao usuário um bônus de aprimoramento a todos os atributos."},
{n="Cinto da Regeneração"						,d=belt_hr_d},
{n="Cinturão de Troll"								,d=belt_hr_d},
{n="Cinturão de Hidra"								,d=belt_hr_d},
-- Headband
{n="Faixa de Cabeça de Inteligência Vasta"				,d="Esta intricada faixa de cabeça dourada está decorada com várias pequenas pedras preciosas azuis e roxas profundas."},
{n="Faixa de Cabeça de Sabedoria Inspirada"				,d="Esta simples faixa de cabeça de bronze está decorada com um intricado padrão de finas gravações verdes."},
{n="Faixa de Cabeça de Carisma Cativante"				,d="Esta atraente faixa de cabeça de prata está decorada com várias pequenas pedras preciosas vermelhas e laranjas."},
{n="Faixa de Cabeça de Superioridade Mental"				,d="Esta faixa de cabeça ornamentada está decorada com numerosos aglomerados de pequenas pedras preciosas."..psy_d},
-- Cloak
{n="Manto de Carisma"							,d="Este manto leve e elegante tem um acabamento prateado altamente decorativo."},
{n="Manto de Resistência"						,d="Pontos de prata ou aço são frequentemente inseridos no tecido desses mantos mágicos. Esta vestimenta oferece proteção mágica."},
{n="Manto de Resistência a Magia"					,d=cloak_sr_d},
{n="Manto Superior de Resistência a Magia"			,d=cloak_sr_d},
{n="Manto Extraordinário de Resistência a Magia"	,d=cloak_sr_d},
...
-- Gloves/Bracers
{n="Manoplas de Poder de Ogro"					,d="Estas manoplas são feitas de couro resistente com rebites de ferro ao longo das costas das mãos e dedos."},
...
{n="Períapt de Sabedoria"							,d="Embora pareça ser uma pérola normal em uma corrente leve, um períapt de sabedoria realmente aumenta a pontuação de Sabedoria do portador."},
...
{n="Períapt de Prova contra Veneno"			,d="Este item é uma pedra preta de corte brilhante em uma delicada corrente de prata. O usuário é imune a veneno."},
-- Ring
...
{n="Pedra Ioun de Força Física"						,d=ioun_d..phy_d},
{n="Pedra Ioun de Mental"						,d=ioun_d..psy_d},
{n="Pedra Ioun Colorida"						,d=ioun_d},
...
{n="Cálice do Choro do Veneno"					,d="Este cálice de prata tem representações estilizadas de unicórnios empinados servindo como alças. O portador do cálice pode expulsar toxinas do corpo de uma criatura envenenada, fazendo com que o alvo chore o veneno dos olhos e permitindo que o portador o colete no cálice."},
{n="Pedra Ioun de Regeneração"					,d=ioun_d},
{n="Cristal de Sangue de Troll"					,d="Um pedaço de cristal com forma estranha, imerso em brilho vermelho escuro."},
...
{n="Manual de Saúde Corporal"					,d="Este volumoso tomo contém dicas sobre saúde e condicionamento físico"..book_post},
{n="Tomo de Mente Clara"						,d="Este pesado livro contém instruções para melhorar a memória e a lógica"..book_post},
{n="Tomo de Compreensão"						,d="Este volumoso livro contém dicas para melhorar o instinto e a percepção"..book_post},
{n="Tomo de Liderança e Influência"			,d="Este pesado livro detalha sugestões para persuadir e inspirar os outros"..book_post},

-- Ammo
{n="Flecha"										,d="Munição para arcos."..amm_d},
{n="Seta"										,d="Munição para bestas."..amm_d},
...
{n="Cajado"					,d="Um cajado consiste em um revestimento macio ao redor de um núcleo duro e denso, tipicamente uma bainha de couro ao redor de uma haste de chumbo. A cabeça é mais larga que o cabo e projetada para espalhar a força do golpe, tornando menos provável que cause sangramento ou quebre ossos."},
...
{n="Kama"					,d="O kama"..s_mnk_wpn.."Por causa da forma do kama, você pode usá-lo para fazer ataques de derrubada."},-- If you are tripped during your own trip attempt, you can drop the kama to avoid being tripped.
...
{n="Último Marcador"	,d="Último marcador."},
}


d_grindstone	= "Mó de amolar são amplamente usados na confecção de vários itens de metal."
...
[itm_bag				]={n="Mochila						",d="Uma mochila é um saco de couro carregado nas costas, tipicamente com alças para prendê-la.				"},
...
[itm_sack				]={n="Saco							",d="Este item é feito de juta ou material similar e tem cordão para que possa ser fechado.		"},
[itm_sack_s				]={n="Saco Pequeno					",d="Esta pequena bolsa é feita de lona ou linho e tem cordão para que possa ser fechada.			"},
...
[itm_agate_band			]={n="Banded Agate					",d="Uma pedra vermelha e lustrosa com faixas de puro branco.												"},
[itm_agate_eye			]={n="Eye Agate						",d="Uma pedra amarelada que brilha como o olho de um gato ao crepúsculo.									"},
[itm_agate_moss			]={n="Moss Agate					",d="Uma gema verde iridescente.																		"},
[itm_azurite			]={n="Azurite						",d="Uma pedra azulada que brilha como um mar ao luar.											"},
[itm_quartz_b			]={n="Blue Quartz					",d="Uma gema de múltiplas facetas de cristal azul-céu.														"},
[itm_hematite			]={n="Hematite						",d="Uma gema vermelho-escura fumegante como ferro recém-forjado.											"},
[itm_lapis_lazuli		]={n="Lapis Lazuli					",d="Uma lágrima de cristal azul-óceano profundo.															"},
[itm_malachite			]={n="Malachite						",d="Uma pequena gema de tons verdes variegados.															"},
[itm_obsidian			]={n="Obsidian						",d="Uma pedra tão negra e escura quanto o coração de um necromante.											"},
[itm_rhodochrosite		]={n="Rhodochrosite					",d="Uma pedra branca nublada com cristais rosados.													"},
[itm_tiger_eye			]={n="Tiger Eye Turquoise			",d="Uma gema negra circundada por listras amarelas selvagens.													"},
[itm_pearl_misc			]={n="Pérola de água doce (Irregular)",d="Uma massa de pérolas leitosa fundidas juntas como ovos de rã."},
...
[itm_carnelian			]={n="Cornalina",d="Uma pedra laranja com um brilho branco iluminando seu centro."},
[itm_chalcedony			]={n="Calcedônia",d="Uma pedra pálida, lavanda, da cor de violetas murchas."},
...
[itm_iolite				]={n="Iolita",d="Uma pedra em forma de diamante da cor do oceano profundo."},
[itm_jasper				]={n="Jaspe",d="Uma pedra âmbar irregular com um brilho tênue."},
...
[itm_peridot			]={n="Peridoto",d="Uma pequena pedra verde que cintila pálida e brilhante em seu núcleo."},
[itm_crystal_clr		]={n="Cristal de rocha (Quartzo transparente)",d="Um pedaço duro de quartzo coberto por um brilho prateado."},
[itm_sard				]={n="Sardo",d="Uma pequena pedra ígnea contendo redemoinhos de cristal brilhante."},
[itm_sardonyx			]={n="Sardo-níquel",d="Uma pedra ígnea, em camadas de anéis de cristal brilhante."},
...
[itm_quartz_star		]={n="Quartzo rosa estrelado",d="Uma pedra rosa turva com uma estrela cristalina branca gravada em sua superfície."},
[itm_zircon				]={n="Zircão",d="Uma pedra quase transparente, fria e azul como gelo glacial."},
...
[itm_jet				]={n="Azeviche							",d="Uma pedra negra cortada com inclusões brancas e cinzas.												"},
...
[itm_alexandrite		]={n="Alexandrita					",d="Uma pedra violeta com veios de inclusões rosa brilhante.												"},
[itm_aquamarine			]={n="Água-marinha					",d="Este cristal puro e azul parece um pedaço de céu transformado em vidro.								"},
[itm_garnet_v			]={n="Granada Violeta					",d="Uma gema roxa cortada em uma elipse de muitas facetas.													"},
[itm_pearl_k			]={n="Pérola Negra					",d="Uma esfera escura e lustrosa, fria ao toque.														"},
[itm_spinel_db			]={n="Espinélia Azul Profundo				",d="Uma gema fria da cor dos mares árticos.															"},
...
[itm_opal_w				]={ n="Opala Branca					",d="Uma gema branca amorfa que refrata a luz em tons azulados iridescentes.							"},
[itm_opal_k				]={ n="Opala Negra					",d="Uma gema negra amorfa que refrata a luz em tons vermelhos cintilantes.						"},
[itm_opal_f				]={ n="Opala de Fogo					",d="Uma gema escura amorfa cintilando em cores iridescentes.										"},
[itm_opal_wt			]={n="Opala de Água					",d="Uma gema semitransparente amorfa que refrata a luz em tons aqua iridescentes.			"},
[itm_sapphire_b			]={n="Safira Azul					",d="Esta gema azul profunda brilha em cada uma de suas facetas suavemente cortadas.								"},
[itm_corundum_y			]={n="Coríndon Amarelo Incandescente			",d="Um cristal duro de vidro dourado puro.															"},
[itm_corundum_p			]={n="Coríndon Roxo Rico			",d="Uma pedra dura, violeta, com inclusões rosadas ramificadas.											"},
[itm_star_sapp_b		]={n="Safira Estelar Azul			",d="Uma safira azul de corte redondo com uma estrela branca brilhante no topo.									"},
[itm_star_sapp_k		]={n="Safira Estelar Negra			",d="Uma safira negra de corte redondo com uma estrela amarela pálida no topo.									"},
[itm_star_ruby			]={n="Rubi Estelar						",d="Uma safira vermelha de corte redondo com uma pequena estrela branca no topo.									"},
...
[itm_diamond_bw			]={n="Diamante Azul-Branco			",d="Digna da tiara de uma rainha, este diamante brilha mesmo nas sombras mais profundas.							"},
...
[itm_sup				]={n="Suprimentos",d="Os grupos de aventura consomem bens e materiais necessários todos os dias, como comida, suprimentos de acampamento e suprimentos de manutenção de equipamentos, etc.. Esses bens e materiais são coletivamente chamados de suprimentos."},
...
[itm_lockpick			]={n="Arrombador",d=d_lockpick		},
...
[itm_eqp_rd_3			]={n="Caixa de Equipamento de Pioneiro",d="Superior à Caixa de Equipamento do Explorador."},
...
[itm_skls_str_head		]={n="Elmo do Campeão de Atletismo		",d="Forjado em adamantino reluzente, este magnífico elmo possui uma pluma de vitória prata-branca no topo. Seus lados são gravados com padrões de coroas de louros, simbolizando glória suprema."},
[itm_skls_str_belt		]={n="Cinto do Campeão de Atletismo		",d="Um cinto largo de couro preto, preso com uma fivela dourada. O centro é adornado com relevos que retratam várias cenas de competições atléticas e triunfos."},
...
[itm_skls_dex_head		]={n="Máscara do Ladrão Noturno Sem Nome	",d="Uma máscara feita de seda preta, que revela apenas os olhos. As bordas são costuradas com linha escura para ocultação, e ela reflete quase nenhuma luz sob a lua."},
[itm_skls_dex_back		]={n="Capa do Ladrão Noturno Sem Nome	",d="Esta capa escura é tecida em lã cinza-escura e forrada com seda preta. A gola possui um fecho secreto para fixação."},
[itm_skls_dex_hand		]={n="Luvas do Ladrão Noturno Sem Nome	",d="Forjadas em couro de cabrito preto macio, as pontas dos dedos são tratadas especialmente para garantir sensibilidade tátil aguçada sem deixar vestígios. As palmas apresentam sulcos antiderrapantes."},
[itm_skls_dex_accs		]={n="Mochila do Ladrão Noturno Sem Nome	",d="Feita de um material que se assemelha a lona impermeável, possui múltiplos bolsos ocultos presos por um fecho de cordão de cobre. Esconde várias ferramentas e pequenos implementos dentro."},
[itm_skls_int_head		]={n="Círculo do Grande Erudito		",d="Forjado em prata refinada por artes antigas, este círculo está incrustado com vários opalas azuis. Diz-se que aguça a mente, permitindo ao usuário concentrar seus pensamentos intensamente."},
[itm_skls_int_ring		]={n="Anel do Grande Erudito			",d="Um anel de ouro exquisitamente trabalhado. O aro é gravado com a imagem de um pergaminho desenrolado, cercado por pequenas pérolas, simbolizando o valor precioso do conhecimento."},
[itm_skls_int_neck		]={n="Amuleto do Grande Erudito		",d="Uma pequena ampulheta dourada suspensa por um cordão de seda azul profundo. Simboliza a sabedoria do tempo, lembrando ao usuário a valorizar cada momento."},
[itm_skls_int_accs		]={n="Tom do Grande Erudito			",d="Este volumoso tomo está encadernado em pele de dragão, com cantos protegidos por ferragens de metal. As páginas são pergaminho amarelado, registrando vários segredos perdidos de conhecimento antigo."},
[itm_skls_wis_head		]={n="Boné do Batedor de Elite				",d="Um boné confortável e macio, costurado em lona verde escura, lindamente elaborado, com uma pena de águia presa à aba."},
[itm_skls_wis_vest		]={n="Camisa do Batedor de Elite			",d="Esta camisa é feita de tecido de duas camadas: a camada externa tem camuflagem de floresta manchada, enquanto a camada interna é lã quente. A gola é adornada com pelagem fofa de lobo."},
...
[itm_skls_wis_accs		]={n="Binóculo do Batedor de Elite		",d="O tubo de latão está inscrito com finas gradações. As lentes são polidas a partir de cristal transparente, permitindo ao usuário ver claramente à distância."},
[itm_skls_cha_head		]={n="Máscara do Homem Sem Rosto			",d="Feita de cerâmica fina, metade preta e metade branca, sua expressão está congelada em um enigmático meio sorriso, impossível de ler."},
...
[itm_skls_cha_neck		]={n="Broche do Homem Sem Rosto			",d="Este broche de prata é um relevo de duas faces. Uma mostra uma rosa, a outra uma adaga. Ele esconde um segredo: ao pressionar um mecanismo libera uma agulha fina."},
[itm_skls_cha_accs		]={n="Kit de Maquiagem do Homem Sem Rosto		",d="Uma delicada caixinha contendo compartimentos para pó de base, bigodes falsos e vários acessórios de disfarce. Um pequeno espelho está inserido na parte interna da tampa."},
[itm_skls_knw_head		]={n="Faixa do Arquissábio			",d="Fabricada a partir do crânio de um dragão antigo, sua base possui uma faixa de ouro escuro gravada com runas dracônicas. A faixa irradia a sabedoria dos séculos, como se contivesse o conhecimento ilimitado que o dragão possuía em vida."},
[itm_skls_knw_ring		]={n="Anel do Arquissábio			",d="Feito de platina, a face do anel está gravada com um mapa em relevo do continente, cercado por marcas de corpos celestes."},
...
[itm_skls_knw_accs		]={n="Tom do Arquissábio			",d="Um códice fino e leve. Sua capa está adornada com várias gemas. Cada vez que uma página é virada, um novo conhecimento é revelado, como se nunca pudesse ser totalmente lido."},
[itm_skls_pfm_head		]={n="Coroa da Deusa da Canção	",d="Tecida com fios dourados em forma de folhas de louro, a folhagem é bordada com pequenas pérolas e pequenos diamantes. Brilha intensamente quando usada, e a voz do portador torna-se ainda mais melódica."},
[itm_skls_pfm_back		]={n="Cachecol da Deusa da Canção		",d="Este cachecol de seda é leve como névoa. Suas bordas são bordadas com notas musicais douradas e requintadas, e quando ondula ao vento, parece sussurrar uma melodia bela e etérea."},
[itm_skls_pfm_neck		]={n="Broche da Deusa da Canção		",d="Uma harpa de prata em miniatura. Um rubi fino está cravado no topo de seu pilar, e suas cordas são feitas de fino fio de ouro. Ao dedilhá-las suavemente produz um som agradável e ressonante."},
[itm_skls_pfm_accs		]={n="Troféu da Deusa da Canção		",d="Uma estatueta da Deusa da Canção, esculpida com requinte. Runas mágicas são gravadas em sua base de ouro maciço, que pulsa ritmicamente com luz sempre que uma canção é cantada nas proximidades."},
...
[itm_bow1_hand			]={n="Braçadeiras Menores de Arco e Flecha						",d="Estas braçadeiras parecem um equipamento protetor normal. Elas capacitam o usuário a usar arcos de forma eficaz."},
[itm_bow2_hand			]={n="Braçadeiras Maiores de Arco e Flecha					",d="Estas braçadeiras parecem um equipamento protetor normal. Elas capacitam o usuário a usar arcos de forma ainda mais eficaz."},
[itm_unrng1_hand		]={n="Luvas Menores de Captura de Flechas				",d="Quando usadas firmemente, estas luvas parecem fundir-se às mãos, tornando-se quase invisíveis. O usuário ganha a habilidade de capturar flechas."},
[itm_unrng2_hand		]={n="Luvas Maiores de Captura de Flechas				",d="Quando usadas firmemente, estas luvas parecem fundir-se às mãos, tornando-se quase invisíveis. O usuário ganha a habilidade de capturar flechas com frequência."},
[itm_mnk1_body			]={n="Túnica do Monge									",d="Uma simples túnica marrom, que ao ser usada aumenta as habilidades de combate desarmado do usuário."},
...
[itm_mnk1_hand			]={n="Arma de Punho do Monge							",d="Rústica e robusta, aumenta as habilidades de combate desarmado do usuário."},
[itm_mnk2_body			]={n="Túnica Maior do Monge							",d="Uma simples túnica marrom, que ao ser usada aumenta significativamente as habilidades de combate desarmado do usuário."},
...
[itm_mnk2_hand			]={n="Arma de Punho Maior do Monge					",d="Rústica e robusta, aumenta significativamente as habilidades de combate desarmado do usuário."},
[itm_dwf_belt			]={n="Cinto da Gente Anã							",d="Um cinto largo ao estilo anão; o usuário ganha alguns traços anões."},
[itm_dwf_head			]={n="Elmo da Gente Anã							",d="Forjado em adamantina, concedendo ao usuário alguns traços anões."},
[itm_dwf_accs			]={n="Emblema da Gente Anã							",d="Um pequeno distintivo de metal gravado com o emblema de um clã anão, que concede ao usuário alguns traços anões."},
[itm_elf_back			]={n="Capa da Elegância Élfica								",d="Fabricada com materiais requintados, elegante e refinada, concedendo ao usuário alguns traços élficos."},
[itm_elf_neck			]={n="Colar da Elegância Élfica							",d="Um colar esguio de mithril, com um pingente em forma de folha pendurado na parte inferior; o usuário ganha alguns traços élficos."},
[itm_elf_ring			]={n="Anel da Elegância Élfica								",d="Um pequeno e delicado anel de ouro, gravado com inscrição élfica, concede ao usuário alguns traços élficos."},
[itm_imx_dis_neck		]={n="Amuleto da Saúde								",d="O usuário desta gema azul em uma corrente de prata é imune a doenças, incluindo doenças sobrenaturais."},
[itm_dis_tox_neck		]={n="Amuleto da Pureza								",d="Este item é uma gema azul e uma gema preta em uma delicada corrente de prata. O usuário é imune a doenças e veneno."},
[itm_dis_tox_accs		]={n="Pedra Ioun da Pureza							",d=ioun_d},
[itm_vest_lock			]={n="Colete de Fuga								",d="Este simples colete de seda pode parecer estranho, mas na verdade está costurado com inúmeras bolsos secretos. As várias ferramentas mágicas ocultas nele podem melhorar significativamente as perícias de Arrombamento, Desativar Dispositivo e Artista da Fuga do usuário."},
[itm_vest_dflc			]={n="Colete de Proteção							",d="Este colete oferece proteção mágica contínua."},
[itm_vest_save			]={n="Camisa da Resistência							",d="Pontos de prata ou aço são frequentemente inseridos no tecido dessas vestes mágicas, proporcionando ao usuário proteção mágica."},
[itm_vest_sr1			]={n="Vestimenta de Resistência à Magia					",d=cloak_sr_d},
[itm_vest_sr2			]={n="Vestimenta Superior de Resistência à Magia			",d=cloak_sr_d},
[itm_vest_sr3			]={n="Vestimenta Extraordinária de Resistência à Magia	",d=cloak_sr_d},
[itm_vest_drd			]={n="Vestimenta do Druida								",d="Esta vestimenta leve é usada sobre roupas ou armaduras normais. A maioria dessas vestes são verdes, bordadas com motivos de plantas ou animais. Quando este item é usado por um personagem com a habilidade Forma Selvagem, ele pode usar essa habilidade com mais frequência."},
[itm_eyes_low			]={n="Olhos da Coruja								",d="Feitos de âmbar. O usuário ganha visão em luz baixa."},
[itm_eyes_dk			]={n="Óculos da Noite								",d="As lentes deste item são feitas de cristal escuro. Embora as lentes sejam opacas, quando colocadas sobre os olhos do usuário permitem que ele veja normalmente, mesmo no escuro."},
[itm_eyes_slow			]={n="Olhos da Lentidão									",d="Quando o usuário fixa o olhar em um alvo válido, o alvo imediatamente fica retardado."},
...
[itm_eyes_dazzled		]={n="Olhos de Deslumbre								",d="Quando o portador vê alvos próximos, os olhos dos alvos ficarão severamente irritados imediatamente."},
[itm_eyes_sickened		]={n="Olhos de Enfermidade								",d="Quando o portador vê alvos próximos, os alvos sofrerão imediatamente de dor súbita e febre."},
[itm_eyes_fatigued		]={n="Olhos de Fadiga								",d="Quando o portador vê alvos próximos, os alvos ficarão imediatamente fatigados."},
[itm_eyes_exhausted		]={n="Olhos de Exaustão								",d="Quando o portador vê alvos próximos, os alvos ficarão imediatamente exaustos."},
-- z_add_itm
...
[itm_troll_shit			]={n="Fezes de Troll					"},
...
[itm_unic_horn			]={n="Chifre de Unicórnio (Lascas)			"},
...
[itm_lzd_l_fang			]={n="Presas de Lagarto Shocker		"},
...
[itm_bear_hair			]={n="Cabelo de Urso						"},
[itm_bear_shit			]={n="Estrume de Urso						"},
[itm_fox_hair			]={n="Cabelo de Raposa						"},
...
[itm_inflict_light_wounds_trap						]={n="Armadilha de Infligir Ferimentos Leves					"},
[itm_javelin_trap									]={n="Armadilha de Dardo								"},
...
unique_itms_text={
[1001]={n="Carta de convite"	,d="A carta é um dos convites enviados pela Guilda dos Aventureiros aos aventureiros de outros continentes, a maioria das palavras está difícil de entender após ter sido embebida nos mares.\n\n\"......A área de aparição e a frequência dos monstros são incrivelmente anormais, fatores humanos não são excluídos...... Estamos desesperadamente precisando de mais aventureiros corajosos, ajudando-nos a superar as dificuldades. Os aventureiros convidados podem escolher seus próprios locais de desembarque, Aileen e Tod serão responsáveis por receber aqueles do continente oriental.\"\n\nO logoff e o selo no final são visíveis vagamente: a Guilda dos Aventureiros Alrthia."},
[1002]={n="Uma carta"			,d="\"Realizando o movimento conforme programado. O banqueiro deve ser capturado vivo enquanto seus guardas podem ser tratados a seu critério. Se não houver mão de obra suficiente, você pode comandar o grande número de esqueletos na masmorra. O dispositivo mencionado da última vez pode ser usado normalmente, apesar da limitação de vezes de uso. Além disso, os comandos só podem ser dados em linguagem comum com no máximo 3 palavras comuns.\n\n--Z\""},
[1003]={n="Dispositivo estranho"		,d="Este dispositivo estranho parece adequado para segurar com uma mão, mas não é usado como arma. Não houve reação ao pressionar o pequeno interruptor no final."},
...
[1005]={n="Presas Pretas"			,d="A adaga negra apresenta um brilho roxo fraco, como se de repente absorvesse sua alma."},
}