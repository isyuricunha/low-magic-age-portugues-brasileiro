...
- Arma arremessada -> slot de munição
...
can_load_arn_save	="Não foi possível carregar o salvamento! Criado e usando o grupo padrão."
...
smod_dir_lbl_gfx_all		= "Pasta de Conteúdo (similar à pasta <url=./gfx>gfx</url> na pasta do jogo):"
...
s_act_bar_pg_tip	= "<h3 c=lbl>Página Atual da Barra de Ações</h3>Navegue entre páginas pelos botões laterais ou teclas de atalho.\n\nBarra de Ações:\n"..s_set_act_tip
